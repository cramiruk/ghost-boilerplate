import { B as l, H as a, m, S as P, u as j } from "./index-D39xCs8v.mjs";
import { am as C, aT as $, a8 as z } from "./stats-BSUAFETq.mjs";
import { R as G, b as R, P as _, a as v, C as M, T as b, D as x, O as D } from "./audience-nOEB8vuJ.mjs";
...
const N = (t, e) => t === e ? !0 : t.endsWith(`.${e}`), Y = (t, e) => {
...
function st({
  ...
  let u = 0;
  if (t.forEach((c) => {
    const { domain: d, isDirectTraffic: E } = Y(c.source, s), f = Number(c.visits || 0);
...
const at = G, ot = R, B = _, A = l(({ className: t, ...e }, s) => /* @__PURE__ */ a.jsx(
  D,
  {
    className: m(
...
), L = l(({ side: t = "right", className: e, children: s, ...o }, n) => /* @__PURE__ */ a.jsx(B, { children: /* @__PURE__ */ a.jsxs("div", { className: P, children: [
  /* @__PURE__ */ a.jsx(A, {}),
  /* @__PURE__ */ a.jsxs(
    v,
    {
      ref: n,
      className: m(F({ side: t }), e),
      ...o,
      children: [
...
const q = l(({ className: t, ...e }, s) => /* @__PURE__ */ a.jsx(
  x,
  {
    ref: s,
...
//# sourceMappingURL=content-helpers-DCYF-0LC.mjs.map
