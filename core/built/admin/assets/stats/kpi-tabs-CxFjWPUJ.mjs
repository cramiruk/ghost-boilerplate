import { B as c, H as a, a2 as G, V as H, Q as f, m, o as Q, u as y } from "./index-D39xCs8v.mjs";
import { bD as q, bC as O, am as x, bF as W, ap as J, a1 as U, a_ as T, b3 as C, b1 as X, al as Y, Q as Z, ac as tt, h as et, aP as at, a7 as nt } from "./stats-BSUAFETq.mjs";
var h = "Tabs", [st] = X(h, [
  C
]), w = C(), [ot, N] = st(h), I = c(
  (t, e) => {
...
var V = "TabsList", _ = c(
  (t, e) => {
    const { __scopeTabs: s, loop: n = !0, ...o } = t, i = N(V, s), r = w(s);
    return /* @__PURE__ */ a.jsx(
      J,
      {
        asChild: !0,
...
//# sourceMappingURL=kpi-tabs-CxFjWPUJ.mjs.map
