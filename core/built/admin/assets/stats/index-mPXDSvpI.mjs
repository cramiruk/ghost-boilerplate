import { s as Me, B as R, H as e, S as Ae, m as h, R as D, a4 as ie, a0 as q, W as L, M as W, w as ne, y as f, z as Z, h as J, j as ee, $ as A, A as Le } from "./index-D39xCs8v.mjs";
import { h as T, aT as De, y as $e, H as Ee, a5 as Re, $ as le, i as F, m as S, n as H, k as I, j as P, aD as y, aC as We, ah as Fe, t as Se, _ as E, aR as oe, a9 as Y, af as He, S as X, T as ce, ac as Ie, aP as Pe, R as Be, g as Ve, Y as V, v as Oe, aZ as K, bg as Q, a7 as Ue, a0 as Ge, aE as Ye, aA as se, ae as te, aQ as Ke, I as Qe, bK as qe, bh as Xe, bS as Ze, bb as $, bP as Je, bx as O, aG as es, aF as ss, ag as ts, K as as, aH as rs, r as is } from "./stats-BSUAFETq.mjs";
import { R as ns, b as ls, P as os, a as de, T as me, D as ue, O as he, e as xe, c as cs } from "./audience-nOEB8vuJ.mjs";
import { u as ds } from "./use-growth-stats-Ct0crZc7.mjs";
...
const k = {
        ...
        /* @__PURE__ */ e.jsx("div", { className: "-ml-4 flex w-full flex-col items-stretch gap-2 pr-6 xl:h-full xl:max-w-none", children: /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-6 pl-10 lg:border-l xl:h-full", children: [
          ...
          j.showEmailMetrics && s.email && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
            ...
            o && /* @__PURE__ */ e.jsxs("div", { className: g, onClick: () => {
              ...
              /* @__PURE__ */ e.jsx("span", { className: "text-[2.2rem] leading-none font-semibold tracking-tighter", children: s.email.email_count && s.count?.clicks ? Z((s.count.clicks || 0) / s.email.email_count) : "0%" })
            ] })
          ] })
        ] }) })
      ] }) : !a && /* @__PURE__ */ e.jsx(
  ...
  const { range: d } = L(), x = a && Ue[a], n = D.useMemo(() => {
    if (!i || i === "empty" || d === J.allTime.value || !l)
      return "";
    ...
    /* @__PURE__ */ e.jsxs(Ds, { className: "relative flex grow flex-row items-start justify-between gap-5 border-none pb-2 xl:pb-4", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
        ...
        /* @__PURE__ */ e.jsx(
          Es,
          {
            diffDirection: d === J.allTime.value ? "hidden" : i,
            diffTooltip: n,
            diffValue: l,
            value: m
          }
  ...
  const { appSettings: s } = W(), { statsConfig: a, isLoading: t, range: r } = L(), { startDate: i, endDate: l, timezone: m } = Xe(r), { isLoading: c, chartData: o, totals: u, currencySymbol: d } = ds(r), { data: x, isLoading: n } = Hs(), { data: p, isLoading: j } = Ze({
    searchParams: {
      date_from: $(i),
      date_to: $(l),
      limit: "5",
...
//# sourceMappingURL=index-mPXDSvpI.mjs.map
