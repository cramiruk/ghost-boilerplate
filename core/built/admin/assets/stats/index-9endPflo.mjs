import { l as U, R as O, D as jt, P as We, a0 as qe, H as a, a4 as re, W as He, M as Ee, a3 as wt, V as Ue, $ as M, y as P, h as z, s as Wt, A as qt, q as Ht, E as R, w as at } from "./index-D39xCs8v.mjs";
import { b6 as L, bt as At, bu as Ut, bv as kt, bw as Zt, bo as ee, aK as Ze, bs as V, a4 as F, bi as St, aW as Qe, a2 as Je, M as Qt, J as Jt, bp as de, bj as se, aB as Xt, b as er, bd as tr, bm as nt, bn as rr, bq as ie, a3 as ar, bA as nr, Z as sr, br as Oe, b7 as ir, p as or, be as lr, bf as we, bT as st, bc as cr, b8 as dr, S as ye, A as ur, h as Xe, by as be, aZ as oe, g as pr, N as fr, Q as mr, O as hr, P as Ae, Y as br, ba as q, bh as je, bb as pe, bH as gr, bg as Z, aD as Ot, T as xr, aI as vr, bO as yr, i as Pe, m as et, n as tt, k as rt, at as _t, ay as Pt, az as Nt, au as Tt, aw as Ke, j as Ne, s as Dt, w as Ct, u as jr, o as wr, aU as Ar, aV as kr, x as Sr, B as it, q as Or, b5 as _r, bR as Pr, aG as Nr, aF as Tr, ag as Dr, K as Cr, aH as Er, r as Rr } from "./stats-BSUAFETq.mjs";
import { S as Mr, k as Lr, a as $r, f as Ir, b as Br, d as Fr, e as Kr, c as Vr, g as Gr, C as ne, j as Yr, l as zr } from "./content-helpers-DCYF-0LC.mjs";
import { T as Et, c as Rt, a as ke, b as W, K as Wr, d as Se } from "./kpi-tabs-CxFjWPUJ.mjs";
import { a as ge, f as K, b as $, c as qr, T as Mt, e as Lt, d as H, S as ue, B as Hr } from "./sort-button-DCiFy3OX.mjs";
import { g as Ie, u as Ur } from "./use-growth-stats-Ct0crZc7.mjs";
import { c as Zr, d as Qr } from "./audience-nOEB8vuJ.mjs";
...
var Me = /* @__PURE__ */ (function(t) {
  ...
  return wa(e, t), xa(e, [{
    ...
    value: function() {
      ...
      }, [1 / 0, -1 / 0]), g = V(s, o, c[0], i), j = V(s, o, c[1], i), p = J(J(J({}, L(d, !1)), {}, {
        fill: "none"
      }, L(h, !1)), {}, {
        x1: g.x,
        y1: g.y,
    ...
    value: function() {
      var r = this, s = this.props, o = s.ticks, i = s.tick, u = s.angle, h = s.tickFormatter, d = s.stroke, c = pt(s, ha), g = this.getTickTextAnchor(), j = L(c, !1), p = L(i, !1), x = o.map(function(m, v) {
        ...
        return /* @__PURE__ */ O.createElement(F, ve({
          className: U("recharts-polar-radius-axis-tick", St(i)),
...
var Da = Math.PI / 180, bt = 1e-5, $e = /* @__PURE__ */ (function(t) {
  ...
  return Na(e, t), Sa(e, [{
    ...
    value: (
       ...
       */
      function(r) {
        var s = this.props, o = s.cx, i = s.cy, u = s.radius, h = s.orientation, d = s.tickSize, c = d || 8, g = V(o, i, u, r.coordinate), j = V(o, i, u + (h === "inner" ? -1 : 1) * c, r.coordinate);
        return {
          x1: g.x,
          y1: g.y,
          x2: j.x,
    ...
    value: function() {
      var r = this, s = this.props, o = s.ticks, i = s.tick, u = s.tickLine, h = s.tickFormatter, d = s.stroke, c = L(this.props, !1), g = L(i, !1), j = X(X({}, c), {}, {
        ...
        return /* @__PURE__ */ O.createElement(F, te({
          className: U("recharts-polar-angle-axis-tick", St(i)),
...
function I(t, e, n) {
  return e = Vt(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Vt(t) {
  var e = Ia(t, "string");
...
var G = /* @__PURE__ */ (function(t) {
  function e(n) {
    var r;
    return Ca(this, e), r = Ra(this, e, [n]), I(r, "pieRef", null), I(r, "sectorRefs", []), I(r, "id", nr("recharts-pie-")), I(r, "handleAnimationEnd", function() {
  ...
  return $a(e, t), Ea(e, [{
    ...
    value: function(r) {
      ...
      var o = this.props, i = o.label, u = o.labelLine, h = o.dataKey, d = o.valueKey, c = L(this.props, !1), g = L(i, !1), j = L(u, !1), p = i && i.offsetRadius || 20, x = r.map(function(m, v) {
        var A = (m.startAngle + m.endAngle) / 2, l = V(m.cx, m.cy, m.outerRadius + p, A), f = D(D(D(D({}, c), m), {}, {
          stroke: "none"
        }, g), {}, {
          index: v,
          ...
          index: v,
          points: [V(m.cx, m.cy, m.outerRadius, A), l]
        }), _ = h;
    ...
    value: function(r, s, o) {
      ...
      if (ee(r))
        return r(s);
      var i = U("recharts-pie-label-line", typeof r != "boolean" ? r.className : "");
    ...
    value: function(r, s, o) {
      ...
      if (ee(r) && (i = r(s), /* @__PURE__ */ O.isValidElement(i)))
        return i;
      var u = U("recharts-pie-label-text", typeof r != "boolean" && !ee(r) ? r.className : "");
...
I(G, "parseDeltaAngle", function(t, e) {
  var n = Oe(e - t), r = Math.min(Math.abs(e - t), 360);
  return n * r;
});
I(G, "getRealPieData", function(t) {
...
I(G, "parseCoordinateOfPie", function(t, e) {
...
I(G, "getComposedData", function(t) {
...
const Gt = ({ className: t }) => {
...
}, Va = ({ chartData: t, totals: e, initialTab: n, currencySymbol: r, isLoading: s, onTabChange: o }) => {
  const i = Fa(n) ? n : "total-members", [u, h] = re(i), { range: d } = He(), { appSettings: c } = Ee(), g = qe(), [j] = wt();
  Ue(() => {
    h(i);
  }, [i]);
  const p = (w) => {
  ...
  return o && (i.timezone = o), Ga({ searchParams: i });
  ...
  return /* @__PURE__ */ a.jsx(ge, { children: s.map((i) => /* @__PURE__ */ a.jsxs(K, { className: "last:border-none", children: [
    /* @__PURE__ */ a.jsx($, { className: "font-medium", children: /* @__PURE__ */ a.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ a.jsx(
        Gr,
        {
    ...
    /* @__PURE__ */ a.jsxs($, { className: "text-right font-mono text-sm", children: [
      "+",
      P(i.free_members)
    ] }),
  ...
  const { data: o } = He(), { data: i } = gr(), { appSettings: u } = Ee(), [h, d] = re("free_members desc"), c = r || h, g = s || d, j = c.replace("free_members", "signups").replace("paid_members", "paid_conversions"), { data: p, isLoading: x } = Ya(t, j, e), m = o?.url, v = "https://www.google.com/s2/favicons?domain=ghost.org&sz=64", A = O.useMemo(() => {
  ...
  return u?.analytics.membersTrackSources ? x ? /* @__PURE__ */ a.jsx(ge, { children: /* @__PURE__ */ a.jsx(K, { className: "last:border-none", children: /* @__PURE__ */ a.jsx($, { className: "border-none py-2", colSpan: 1, children: /* @__PURE__ */ a.jsx(Ot, { containerClassName: "space-y-2", count: 5, maxWidth: 75, randomize: !0 }) }) }) }) : /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
    ...
    ) : /* @__PURE__ */ a.jsx(ge, { children: /* @__PURE__ */ a.jsx(K, { className: "last:border-none", children: /* @__PURE__ */ a.jsx($, { className: "border-none py-12 group-hover:bg-transparent!", colSpan: u?.paidMembersEnabled ? 4 : 2, children: /* @__PURE__ */ a.jsx(
      ye,
      {
    ...
    n && l.length > e && /* @__PURE__ */ a.jsx(qr, { className: "border-none bg-transparent hover:bg-transparent!", children: /* @__PURE__ */ a.jsx(K, { children: /* @__PURE__ */ a.jsx($, { className: "border-none bg-transparent px-0 pb-0 hover:bg-transparent!", colSpan: 4, children: /* @__PURE__ */ a.jsxs($r, { children: [
      ...
      /* @__PURE__ */ a.jsxs(Br, { className: "overflow-y-auto pt-0 sm:max-w-[420px]", children: [
        ...
        /* @__PURE__ */ a.jsx("div", { className: "group/datalist", children: /* @__PURE__ */ a.jsxs(Mt, { children: [
          /* @__PURE__ */ a.jsx(Lt, { children: /* @__PURE__ */ a.jsxs(K, { children: [
            ...
            /* @__PURE__ */ a.jsx(H, { className: "w-[110px] text-right", children: /* @__PURE__ */ a.jsx(ue, { activeSortBy: c, setSortBy: g, sortBy: "free_members desc", children: "Free members" }) }),
            u?.paidMembersEnabled && /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
              /* @__PURE__ */ a.jsx(H, { className: "w-[110px] text-right", children: /* @__PURE__ */ a.jsx(ue, { activeSortBy: c, setSortBy: g, sortBy: "paid_members desc", children: "Paid members" }) }),
              /* @__PURE__ */ a.jsx(H, { className: "w-[110px] text-right", children: /* @__PURE__ */ a.jsx(ue, { activeSortBy: c, setSortBy: g, sortBy: "mrr desc", children: "MRR impact" }) })
            ] })
          ] }) }),
          /* @__PURE__ */ a.jsx(
            vt,
  ...
  ] }) : /* @__PURE__ */ a.jsx(ge, { children: /* @__PURE__ */ a.jsx(K, { className: "last:border-none", children: /* @__PURE__ */ a.jsx($, { className: "border-none py-12 group-hover:bg-transparent!", colSpan: u?.paidMembersEnabled ? 4 : 2, children: /* @__PURE__ */ a.jsx(Gt, {}) }) }) });
}, Wa = "TiersResponseType", qa = Ht({
  dataType: Wa,
  path: "/tiers/",
  ...
  const { range: t, site: e, settings: n } = He(), r = String(n.find((b) => b.key === "timezone")?.value || "Etc/UTC"), s = qe(), [o, i] = re("free_members desc"), [u, h] = re(ne.POSTS_AND_PAGES), [d] = wt(), { appSettings: c } = Ee(), g = d.get("tab") || "total-members", [j, p] = re(g);
  Ue(() => {
    g !== j && p(g);
  }, [g]);
  const { isLoading: x, chartData: m, totals: v, currencySymbol: A, subscriptionData: l } = Ur(t), { data: f, isLoading: T } = Xa(
    t,
    o,
    u
  ), _ = M(() => {
  ...
  return /* @__PURE__ */ a.jsxs(Nr, { children: [
    ...
    /* @__PURE__ */ a.jsxs(Er, { data: k ? void 0 : m, isLoading: !1, loadingComponent: /* @__PURE__ */ a.jsx(a.Fragment, {}), children: [
      ...
      c?.paidMembersEnabled && j === "paid-members" && /* @__PURE__ */ a.jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-[2fr_minmax(460px,1fr)]", children: [
        ...
        /* @__PURE__ */ a.jsx(Ua, { isLoading: k, range: t })
      ] }),
      /* @__PURE__ */ a.jsxs(Pe, { className: "w-full overflow-x-auto", "data-testid": "top-content-card", children: [
        ...
        /* @__PURE__ */ a.jsx(Ne, { children: /* @__PURE__ */ a.jsxs(Mt, { children: [
          /* @__PURE__ */ a.jsx(Lt, { children: /* @__PURE__ */ a.jsxs(K, { className: "[&>th]:h-auto [&>th]:pt-0 [&>th]:pb-2", children: [
            /* @__PURE__ */ a.jsx(H, { className: "min-w-[320px] pl-0", children: /* @__PURE__ */ a.jsx(Et, { defaultValue: u, variant: "button-sm", onValueChange: (b) => {
              h(b);
          ...
          ] }, `${u}-${b.post_id || `${b.title}-${S}`}`)) : /* @__PURE__ */ a.jsx(K, { className: "border-none", children: /* @__PURE__ */ a.jsx($, { className: "py-12 group-hover:bg-transparent!", colSpan: c?.paidMembersEnabled ? 4 : 2, children: /* @__PURE__ */ a.jsx(
            ye,
            {
              description: "Try adjusting your date range to see more data.",
              title: `No conversions ${Z(t)}`,
          ...
          ) }) }) : /* @__PURE__ */ a.jsx(K, { className: "last:border-none", children: /* @__PURE__ */ a.jsx($, { className: "border-none py-12 group-hover:bg-transparent!", colSpan: c?.paidMembersEnabled ? 4 : 2, children: /* @__PURE__ */ a.jsx(Gt, {}) }) }) })
        ] }) })
      ] })
    ] })
  ] });
...
//# sourceMappingURL=index-9endPflo.mjs.map
