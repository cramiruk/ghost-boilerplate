import { T as M, P as L, Q as $, D as E, O as y, ak as S, q as j } from "./index-SJHuYNt9.mjs";
class v {
  /**
  @internal
  */
...
function O(l, t, e, s, i, h) {
  ...
  t: for (; (n & l[r]) != 0; ) {
    ...
    for (; f < d; ) {
      let c = f + d >> 1, p = a + c + (c << 1), b = l[p], F = l[p + 1] || 65536;
      if (u < b)
        d = c;
      else if (u >= F)
        f = c + 1;
...
//# sourceMappingURL=index-iP3YbLQP.mjs.map
