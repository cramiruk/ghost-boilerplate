import { a_ as S, cz as z, cN as B, cU as u, aT as H, cs as L, cp as i, au as M, bv as r, Y as O, H as T, m as V } from "./index-SJHuYNt9.mjs";
const G = [
  ...
  const h = z(), n = B(null), [v, w] = u(100), [l, j] = H.useState(null), [R, k] = u({
    crosshairCursor: !1
  ...
  i(() => {
    Promise.all(c).then(j), k((e) => ({ setup: e, searchKeymap: !1 }));
  }, [c]), i(() => {
    const e = new ResizeObserver(([N]) => {
      w(N.contentRect.width);
    });
  ...
  return /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    ...
    l && /* @__PURE__ */ r.jsxs("div", { className: s === "full" ? "h-full" : "", style: { width: v }, children: [
      ...
      t && /* @__PURE__ */ r.jsx(T, { className: "order-1 text-grey-700! peer-focus:text-black!", htmlFor: h, useLabelTag: !0, children: t }),
...
//# sourceMappingURL=code-editor-view-BJXRSM1U.mjs.map
