import { L as k, E as $, a as z } from "./index-iP3YbLQP.mjs";
import { bK as R, bN as t, t as Y, L as W, bi as Z, aB as x, aW as G, aV as V, bM as _, R as E, q as U } from "./index-SJHuYNt9.mjs";
...
const ge = (e) => (r) => {
  ...
  return n && n.name == ":" && l.name == "PseudoClassSelector" ? { from: O, options: g, validFor: d } : n && n.name == ":" && l.name == "Declaration" || l.name == "ArgList" ? { from: O, options: y, validFor: d } : l.name == "Block" || l.name == "Styles" ? { from: O, options: u(), validFor: d } : null;
}, ye = /* @__PURE__ */ ge((e) => e.name == "VariableName"), f = /* @__PURE__ */ W.define({
  name: "css",
...
export {
  ...
  f as cssLanguage,
  ge as defineCSSCompletionSource
};
//# sourceMappingURL=index-CbJ3vpTZ.mjs.map
