import { aF as y, bK as g, aZ as e, t as b, a6 as j, bM as v, a$ as p, bU as w, bN as R, aP as N, A as T, a8 as M } from "./index-B0iXXgvy.mjs";
const C = [
  ["path", { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6", key: "miytrc" }],
  ["path", { d: "M3 6h18", key: "d0wm0j" }],
  ["path", { d: "M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2", key: "e791ji" }]
], S = y("trash", C), A = ({ count: t, onClick: l, variant: d = "default", preserveScroll: a = !0, loading: c = !1 }) => {
  const n = g(null), i = () => {
    if (t && t > 0)
...
}, L = ({ last: t }) => /* @__PURE__ */ e.jsxs("div", { className: "relative mt-[-5px] py-5", children: [
...
//# sourceMappingURL=deleted-feed-item-BIJgk8lf.mjs.map
