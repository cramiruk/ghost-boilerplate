import { bK as _, bB as b, br as Y, aE as k, aO as Z, by as K, bn as q, aC as Q, x as tt, bV as et, bP as O } from "./index-B0iXXgvy.mjs";
...
function ut(n, t, e, i) {
  ...
  for (const d of s) {
    ...
    h === "integer" ? (f = !0, a.push(...d.value.split("").map((C) => ({ type: h, value: parseInt(C) })))) : h === "group" ? a.push({ type: h, value: d.value }) : h === "decimal" ? (m = !0, o.push({ type: h, value: d.value, key: p(h) })) : h === "fraction" ? o.push(...d.value.split("").map((C) => ({
      type: h,
      value: parseInt(C),
      key: p(h),
      pos: -1 - c[h]
...
class X extends at {
  ...
  set data(t) {
    ...
    if (this.created) {
      ...
      this.nonce && (c.nonce = this.nonce), c.textContent = D, this.shadowRoot.appendChild(c), this._pre = new V(this, s, {
        justify: "right",
        part: "left"
      }), this.shadowRoot.appendChild(this._pre.el), this._num = new ft(this, r, a), this.shadowRoot.appendChild(this._num.el), this._post = new V(this, o, {
        justify: "left",
        part: "right"
...
class bt extends tt {
  ...
  render() {
    const [t, { innerRef: e, className: i, data: s, nonce: r, willChange: a, isolate: o, group: l, digits: c, onAnimationsStart: p, onAnimationsFinish: u, ...f }] = I(this.props);
    return (
...
const Ct = /* @__PURE__ */ Z(function({ value: t, locales: e, format: i, prefix: s, suffix: r, ...a }, o) {
  K(o, () => l.current, []);
  const l = _(), c = q(G);
  c?.useRegister(l);
...
//# sourceMappingURL=index-CTaZw7HN.mjs.map
