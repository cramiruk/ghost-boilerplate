import { bb as E, bN as n, bK as F, bs as H, bp as z, bm as I, bj as M, br as T, b7 as c, aZ as e, a4 as p, _ as y, a6 as h, t as i, D as O, J as P, E as R, H as U, I as L, A as _, $ as S, C as Y, P as W, b as Z, e as V, h as $, i as J, f as K, g as X, d as q, c as G, ay as Q } from "./index-B0iXXgvy.mjs";
import { E as ee } from "./edit-profile-Ck2RrCzp.mjs";
import { C as se } from "./copy-DmuEDzBd.mjs";
const ae = 5e3, re = 12, ie = () => {
  const { data: s, isLoading: b } = E("index", "me"), [l, a] = n(() => s?.blueskyEnabled && !s?.blueskyHandleConfirmed), [j, x] = n(!1), [v, d] = n(!1), [k, u] = n(!1), [w, o] = n(!1), t = F(0), C = H("index"), m = z("index"), N = I("index"), A = async () => {
    ...
    /* @__PURE__ */ e.jsxs("div", { className: "mx-auto max-w-[620px] py-[min(4vh,48px)]", children: [
      ...
      f ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        ...
        s?.avatarUrl ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
          /* @__PURE__ */ e.jsx(i, { className: "h-10 text-base", disabled: l, variant: "secondary", onClick: B, children: l ? /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          l && /* @__PURE__ */ e.jsx("p", { className: "-mt-2 text-center text-sm text-gray-700 dark:text-gray-600", children: "You can leave this page and come back to check the status." })
        ] }) : /* @__PURE__ */ e.jsxs(O, { open: v, onOpenChange: d, children: [
          /* @__PURE__ */ e.jsx(P, { children: /* @__PURE__ */ e.jsx(i, { className: "h-10 w-full text-base", variant: "secondary", children: "Edit profile" }) }),
          /* @__PURE__ */ e.jsxs(R, { className: "w-full max-w-[520px]", onOpenAutoFocus: (r) => r.preventDefault(), children: [
            /* @__PURE__ */ e.jsx(U, { children: /* @__PURE__ */ e.jsx(L, { children: "Profile settings" }) }),
            s && /* @__PURE__ */ e.jsx(ee, { account: s, setIsEditingProfile: d })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ e.jsx(Z, { open: k, onOpenChange: u, children: /* @__PURE__ */ e.jsxs(V, { children: [
      /* @__PURE__ */ e.jsxs($, { children: [
        /* @__PURE__ */ e.jsx(J, { children: "Disable Bluesky sharing?" }),
        /* @__PURE__ */ e.jsx(K, { children: "Your bridged Bluesky account will be deactivated and your content will no longer be shared on Bluesky. You can re-enable sharing at any time." })
      ] }),
      /* @__PURE__ */ e.jsxs(X, { children: [
        ...
        /* @__PURE__ */ e.jsx(
          G,
          {
            ...
            children: l ? /* @__PURE__ */ e.jsx(h, { color: "light", size: "sm" }) : "Disable"
          }
        )
      ] })
    ] }) })
...
//# sourceMappingURL=bluesky-sharing-D8sZrHfn.mjs.map
