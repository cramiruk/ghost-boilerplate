import { bg as F, bh as T, bf as _, bS as R, bN as d, be as E, bR as H, bC as V, aZ as e, a4 as W, _ as $, a9 as k, aa as j, r as p, aj as Z, a as v, A as q, ar as t, t as c, aR as z, b7 as i } from "./index-B0iXXgvy.mjs";
import { T as G, b as J, c as w, a as f } from "./tabs-CrvFCRYq.mjs";
const Q = () => {
  const { data: N, isLoading: n } = F("index"), { data: g, isLoading: o } = T("index"), u = n ? Array(5).fill({ apId: "", name: "", handle: "", avatarUrl: "" }) : N?.pages.flatMap((s) => s.accounts) ?? [], x = o ? Array(5).fill({ apId: "", name: "" }) : g?.pages.flatMap((s) => s.domains) ?? [], U = _("index"), I = R("index"), [D, m] = d(/* @__PURE__ */ new Set()), M = E("index"), B = H("index"), [y, h] = d(/* @__PURE__ */ new Set()), [b, r] = d(null), S = V(), A = (s) => {
    m((l) => {
  ...
  return /* @__PURE__ */ e.jsx(W, { children: /* @__PURE__ */ e.jsxs("div", { className: "mx-auto max-w-[620px] py-[min(4vh,48px)]", children: [
...
//# sourceMappingURL=moderation-CKrTd-i0.mjs.map
