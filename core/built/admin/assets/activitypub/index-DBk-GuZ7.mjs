import { aF as ce, bb as X, bK as y, br as C, bC as S, aZ as e, a9 as z, aa as V, av as Me, aP as Be, ak as De, aj as Pe, a as Te, A as de, t as p, W as xe, aR as Fe, a6 as Z, a1 as Ie, S as ue, bN as v, bj as Oe, b as me, j as Ae, e as he, h as q, i as W, f as G, a0 as J, au as Re, Y as $e, g as K, d as fe, b7 as B, ac as He, af as Ee, ae as Le, ad as oe, c as Se, ay as ze, bH as pe, bA as Ve, bD as _e, bB as Qe, bf as Ye, bS as qe, be as We, bR as Ge, a4 as re, N as Je, M as Ke, ar as R, L as Xe, D as Ze, J as es, E as ss, H as ls, I as ns, _ as as, C as os, q as rs, b5 as te, b1 as ts, b6 as is, ax as Q, r as cs, aV as ds, O as xs, bI as us, ba as be, bJ as ms } from "./index-B0iXXgvy.mjs";
import { S as je } from "./separator-cWtiQJTG.mjs";
import { E as hs } from "./edit-profile-Ck2RrCzp.mjs";
import { T as fs, b as ps, c as E, d as Y, a as L } from "./tabs-CrvFCRYq.mjs";
import { S as bs } from "./settings-Dqr-SdrV.mjs";
import { C as js } from "./copy-DmuEDzBd.mjs";
const gs = [
  [
    "path",
    {
...
const ge = ({
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: "pt-3", "data-testid": "actor-list", children: [
    u === !1 && r.length === 0 ? /* @__PURE__ */ e.jsxs(z, { children: [
      /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(Me, {}) }),
      s
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    n === !1 && s.length === 0 && /* @__PURE__ */ e.jsxs(z, { children: [
      /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(Ie, {}) }),
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    n === !1 && s.length === 0 && /* @__PURE__ */ e.jsxs(z, { children: [
      /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(ks, {}) }),
      d
    ] }),
  ...
  const F = () => {
    ...
    /* @__PURE__ */ e.jsxs(q, { children: [
      ...
      /* @__PURE__ */ e.jsx(G, { className: "mt-4!", asChild: !0, children: /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col rounded-md border", children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "flex justify-between gap-6 p-5", children: [
          ...
          /* @__PURE__ */ e.jsxs(p, { className: `gap-1 ${l.domainUnblocked ? "pointer-events-none border-green bg-green text-white hover:bg-green hover:text-white" : "text-red hover:text-red-400"}`, variant: "outline", onClick: H, children: [
            /* @__PURE__ */ e.jsx($e, {}),
    ...
    return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      /* @__PURE__ */ e.jsxs(q, { children: [
        /* @__PURE__ */ e.jsx(W, { className: "mb-1 flex flex-col gap-1", children: f ? "Unblock this user?" : "Unblock this domain?" }),
      ...
      /* @__PURE__ */ e.jsxs(K, { children: [
        ...
        /* @__PURE__ */ e.jsx(p, { onClick: f ? $ : H, children: "Unblock" })
      ] })
    ] });
  };
  ...
  const [a, t] = v(null), [x, l] = v(!1), h = (m) => {
    ...
    /* @__PURE__ */ e.jsxs(q, { children: [
      /* @__PURE__ */ e.jsx(W, { className: "mb-1 flex flex-col gap-1", children: a === "user" ? "Block this user?" : "Block this domain?" }),
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    /* @__PURE__ */ e.jsxs(He, { children: [
      /* @__PURE__ */ e.jsx(Ee, { disabled: d, asChild: !0, onClick: (m) => m.stopPropagation(), children: r }),
  ...
  const o = pe(), a = Ve(), t = S(), { canGoBack: x } = _e(), l = o.handle ? `/profile/${o.handle}` : "/profile", h = !o.handle, b = o.handle ? o.tab || "" : a.pathname.split("/").pop() || "", g = Qe(() => h ? ["likes", "following", "followers"] : ["following", "followers"], [h]), k = g.includes(b) ? b : "posts", N = Ye("index"), D = qe("index"), F = We("index"), m = Ge("index"), $ = X("index", "me"), { data: H } = o.handle ? $ : { data: void 0 }, I = o.handle === H?.handle || !o.handle, P = s?.blockedByMe, T = s?.domainBlockedByMe, [f, U] = v(!1), [O, j] = v(!1), M = y(null);
  C(() => () => {
  ...
  C(() => {
    _.current && Ne(_.current.scrollHeight > 160);
  }, [A, s?.bio, r, n]), C(() => {
  ...
  return !n && !s ? /* @__PURE__ */ e.jsx(re, { children: /* @__PURE__ */ e.jsx("div", { className: "mx-auto mt-4 flex w-full max-w-[620px] flex-col items-center [&_svg]:translate-x-px", children: /* @__PURE__ */ e.jsxs(Je, { children: [
    ...
    /* @__PURE__ */ e.jsxs("div", { className: `mx-auto max-w-[620px] px-6 ${!s?.bannerImageUrl && !x ? "-mt-8" : "-mt-12"}`, children: [
      ...
      (s?.bio || r?.length > 0) && /* @__PURE__ */ e.jsxs("div", { ref: _, className: `ap-profile-content break-anywhere relative text-[1.5rem] [&>p]:mb-3 ${A ? "max-h-none pb-7" : "max-h-[160px] overflow-hidden"} relative`, children: [
        ...
        fs,
        {
          ...
          children: [
            /* @__PURE__ */ e.jsxs(ps, { children: [
              /* @__PURE__ */ e.jsx(E, { value: "posts", children: "Posts" }),
              h && /* @__PURE__ */ e.jsxs(E, { value: "likes", children: [
                "Likes",
                /* @__PURE__ */ e.jsx(Y, { children: Q(s?.likedCount || 0) })
              ] }),
              /* @__PURE__ */ e.jsxs(E, { value: "following", children: [
                "Following",
                /* @__PURE__ */ e.jsx(Y, { children: Q(s?.followingCount || 0) })
              ] }),
              /* @__PURE__ */ e.jsxs(E, { value: "followers", children: [
                "Followers",
                /* @__PURE__ */ e.jsx(Y, { children: Q(s?.followerCount || 0) })
              ] })
            ] }),
            /* @__PURE__ */ e.jsx(L, { value: "posts", children: (P || T) && !f ? /* @__PURE__ */ e.jsxs(z, { children: [
              /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(cs, {}) }),
  ...
  })) || [], i = /* @__PURE__ */ e.jsx(Ds, { handle: s.handle || "" }), o = /* @__PURE__ */ e.jsx(Ps, {}), a = /* @__PURE__ */ e.jsx(Ts, { handle: s.handle || "" }), t = /* @__PURE__ */ e.jsx(Fs, { handle: s.handle || "" });
  return /* @__PURE__ */ e.jsx(
    Bs,
    {
      account: r,
...
//# sourceMappingURL=index-DBk-GuZ7.mjs.map
