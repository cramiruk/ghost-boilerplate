import { aO as d, bo as Ut, aZ as r, ai as w, bw as Bt, aA as g, bK as h, br as A, ah as K, aD as se, k as zt, aG as we, bl as $, aS as Xt, bN as re, bv as Yt, bj as j, al as Ht, X as Wt, V as Zt, K as qt, y as Jt, bk as Qt, m as en, aB as Ne, aI as tn, aL as nn, ag as on, aF as rn, w as an, az as C, ao as Ie, C as sn, bn as W, aC as cn, aK as ie } from "./index-B0iXXgvy.mjs";
import { u as dn, R as De, I as Te, a as Z, c as un } from "./index-CdAlf8Du.mjs";
var q = "Tabs", [ln] = se(q, [
  Z
...
var Ae = "TabsTrigger", Re = d(
  (e, n) => {
    const { __scopeTabs: t, value: o, disabled: a = !1, ...s } = e, c = ce(Ae, t), u = Se(t), p = Fe(c.baseId, o), v = Le(c.baseId, o), f = o === c.value;
    return /* @__PURE__ */ r.jsx(
      Te,
      {
        asChild: !0,
...
var Ge = Pe, Ke = je, de = Re, $e = Oe, ae = ["Enter", " "], fn = ["ArrowDown", "PageUp", "Home"], Ve = ["ArrowUp", "PageDown", "End"], mn = [...fn, ...Ve], vn = {
  ltr: [...ae, "ArrowRight"],
  rtl: [...ae, "ArrowLeft"]
}, gn = {
  ltr: ["ArrowLeft"],
  ...
  we,
  Z
]), ue = we(), Be = Z(), [Go, D] = I(J), [Ko, V] = I(J), bn = "MenuAnchor", le = d(
  (e, n) => {
...
var _ = "MenuContent", [_n, fe] = I(_), Ye = d(
  ...
  (e, n) => {
    const {
      ...
      ...T
    } = e, R = D(_, t), S = V(_, t), kt = ue(t), Ot = Be(t), he = xn(t), [Ft, be] = re(null), B = h(null), Lt = $(n, B, R.onContentChange), z = h(0), X = h(""), Gt = h(0), ee = h(null), Me = h("right"), te = h(0), Kt = x ? Ht : Wt, $t = x ? { as: wn, allowPinchZoom: !0 } : void 0, Vt = (l) => {
    ...
    const P = j((l) => Me.current === ee.current?.side && Ln(l, ee.current?.area), []);
    return /* @__PURE__ */ r.jsx(
      _n,
      {
        scope: t,
              ...
              qt,
              {
                ...
                children: /* @__PURE__ */ r.jsx(
                  De,
                  {
                    ...
                    onEntryFocus: g(p, (l) => {
                      S.isUsingKeyboardRef.current || l.preventDefault();
                    }),
...
var Qe = "MenuRadioItem", et = d(
  (e, n) => {
    const { value: t, ...o } = e, a = Sn(Qe, e.__scopeMenu), s = t === a.value;
      ...
      We,
      {
        ...
        onPointerLeave: g(
          ...
          G((i) => {
            ...
            if (m) {
              const y = t.content?.dataset.side, x = y === "right", T = x ? -5 : 5, R = m[x ? "left" : "right"], S = m[x ? "right" : "left"];
...
var Gn = le, Kn = Xe, $n = Ye, Vn = ve, Un = He, Bn = Q, zn = Ze, Xn = Je, Yn = et, Hn = nt, Wn = ot, Zn = rt, qn = st, Jn = ct, ut = "DropdownMenu", [Qn] = se(
  ut,
  [Ue]
...
wt.displayName = vo;
var go = ft, xo = mt, Nt = gt, It = xt, Dt = ht, Tt = bt, St = Mt, Pt = _t, Et = Ct, jt = yt, At = wt;
...
//# sourceMappingURL=tabs-CrvFCRYq.mjs.map
