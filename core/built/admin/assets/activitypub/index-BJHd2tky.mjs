import { aF as N, bG as v, bH as y, bC as j, bt as k, br as F, aZ as e, a4 as P, a0 as B, t as C, aw as E, ak as M, a6 as T, bb as H, aj as U, A, ar as x, W as I, b5 as L, b1 as z, b6 as S } from "./index-B0iXXgvy.mjs";
import { T as _ } from "./topic-filter-BbT9TEaX.mjs";
const W = [
  [
    "path",
    {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ e.jsxs("div", { className: "flex w-full flex-col gap-1 border-b border-gray-200 pb-4 dark:border-gray-950", children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ e.jsx(U, { actor: a, isCurrentUser: n, children: /* @__PURE__ */ e.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ e.jsx(A, { author: {
              icon: {
                url: a.avatarUrl
              },
              name: a.name,
        ...
        /* @__PURE__ */ e.jsx("div", { className: "pl-[52px]", children: t ? /* @__PURE__ */ e.jsx(x, { className: "w-full max-w-96" }) : a.bio && /* @__PURE__ */ e.jsx(
          "div",
          {
            dangerouslySetInnerHTML: { __html: L(z(S(a.bio, ["a", "br"]))) },
  ...
  return F(() => {
    ...
    !a && /* @__PURE__ */ e.jsxs("div", { className: "relative mb-6 flex items-start gap-1 rounded-md bg-gradient-to-r from-[#CFB0FF66] to-[#B6E8FF66] p-4 pr-10 dark:from-[#CFB0FF20] dark:to-[#B6E8FF20]", children: [
      ...
      /* @__PURE__ */ e.jsx(C, { className: "absolute top-[17px] right-4 size-6 opacity-40", variant: "link", onClick: () => l(!0), children: /* @__PURE__ */ e.jsx(E, { size: 20 }) })
    ] }),
    /* @__PURE__ */ e.jsx(
      _,
      {
...
//# sourceMappingURL=index-BJHd2tky.mjs.map
