import { aZ as e, az as d, bB as L, aK as H, b9 as F, bc as M, bL as z, bN as o, a4 as I, _ as R, a3 as S, t as f, a6 as k, ar as $, at as D } from "./index-B0iXXgvy.mjs";
import { L as U } from "./label-qzLCDFR2.mjs";
const T = H(
...
const Y = () => {
  const {
    ...
    isLoading: s,
    refetch: c
  } = F("index"), i = M("index"), l = z("index"), [x, g] = o(""), [r, u] = o(null), [p, m] = o(null), [v, b] = o(null), y = [...t?.aliases ?? []].reverse(), A = s || a || y.length > 0, C = async (n) => {
    n.preventDefault();
    const j = x.trim();
    if (!V.test(j)) {
  ...
  return /* @__PURE__ */ e.jsx(I, { children: /* @__PURE__ */ e.jsxs("div", { className: "mx-auto max-w-[620px] py-[min(4vh,48px)]", children: [
    ...
    /* @__PURE__ */ e.jsx("form", { className: "mt-10", onSubmit: C, children: /* @__PURE__ */ e.jsxs(_, { "data-invalid": r ? !0 : void 0, children: [
      /* @__PURE__ */ e.jsx(w, { htmlFor: "account-migration-source-handle", children: "Old account handle" }),
      /* @__PURE__ */ e.jsx(B, { id: "account-migration-source-handle-description", children: "Specify the username@domain of the account you want to move from" }),
      ...
      r && /* @__PURE__ */ e.jsx(N, { id: "account-migration-source-handle-error", children: r }),
      p && /* @__PURE__ */ e.jsx(N, { id: "account-migration-alias-error", children: p })
    ] }) }),
    A && /* @__PURE__ */ e.jsxs("div", { className: "mt-10", "data-testid": "account-migration-aliases", children: [
      ...
      s ? /* @__PURE__ */ e.jsx("div", { className: "border-t border-gray-200 py-4 dark:border-gray-950", children: /* @__PURE__ */ e.jsx($, { className: "h-5 w-48" }) }) : a ? /* @__PURE__ */ e.jsxs("div", { className: "flex items-center justify-between gap-4 border-t border-gray-200 py-4 text-sm text-gray-700 dark:border-gray-950 dark:text-gray-600", children: [
        ...
        /* @__PURE__ */ e.jsx("div", { className: "min-w-0 truncate text-base text-black dark:text-white", children: K(n.apId) }),
        /* @__PURE__ */ e.jsx(
          f,
          {
...
//# sourceMappingURL=account-migration-DO9njBYF.mjs.map
