import { aF as Xn, ak as Z, aZ as n, az as Nn, bN as w, br as F, ac as In, af as Pn, t as M, a2 as Gn, ae as Fn, ab as ne, bK as U, a_ as ee, bj as yn, bC as Ln, B as hn, ar as E, aj as te, A as ae, aP as wn, b3 as oe, aR as re, W as ie, T as de, a6 as mn, S as sn, aW as ln, aQ as ce, bB as se, aM as le, b1 as ge, aN as D, aX as jn, bD as pe, bH as ue, bQ as he, a4 as me, D as ke, E as fe, H as be, I as xe, F as ve, bz as ye, bq as we, aV as Cn, O as je } from "./index-B0iXXgvy.mjs";
import { u as Ce, D as ze, A as Se, S as zn } from "./deleted-feed-item-BIJgk8lf.mjs";
import { T as _e } from "./topic-filter-BbT9TEaX.mjs";
import { S as Ee } from "./separator-cWtiQJTG.mjs";
import { I as Sn } from "./inbox-B8ClTcbc.mjs";
const Ne = [["path", { d: "M5 12h14", key: "1ays0h" }]], Ie = Xn("minus", Ne), On = Z.forwardRef(({ children: t, className: r, ...a }, s) => /* @__PURE__ */ n.jsx(
  "div",
  {
    ref: s,
    className: Nn("flex items-center justify-center rounded-full bg-muted w-12 h-12 max-w-12 max-h-12 [&_svg]:size-4 [&_svg]:text-muted-foreground [&_svg]:shrink-0", r),
    ...a,
    children: t
  }
));
On.displayName = "EmptyBadge";
const kn = Z.forwardRef(({ children: t, className: r, title: a, description: s, actions: i, ...p }, d) => /* @__PURE__ */ n.jsxs("div", { ref: d, className: Nn("flex flex-col items-center justify-center gap-3 text-center", r), ...p, children: [
  /* @__PURE__ */ n.jsx(On, { children: t }),
  /* @__PURE__ */ n.jsxs("div", { className: "flex max-w-[320px] flex-col gap-1.5", children: [
    /* @__PURE__ */ n.jsx("h3", { className: "text-md font-medium tracking-normal text-pretty text-foreground", children: a }),
    s && /* @__PURE__ */ n.jsx("p", { className: "text-sm leading-tight text-pretty text-muted-foreground", children: s })
  ] }),
  i && /* @__PURE__ */ n.jsx("div", { className: "flex items-center gap-2", children: i })
] }));
...
const fn = ["1.5rem", "1.6rem", "1.7rem", "1.8rem", "2rem"], Q = {
  ...
  const [t, r] = w(() => localStorage.getItem(Q.BACKGROUND_COLOR)?.toUpperCase() || "SYSTEM"), [a, s] = w(() => {
    const o = localStorage.getItem(Q.FONT_SIZE);
    return o ? parseInt(o) : 2;
  }), [i, p] = w(() => localStorage.getItem(Q.FONT_STYLE) || "sans"), d = (o) => {
    r(o), localStorage.setItem(Q.BACKGROUND_COLOR, P[o].id);
  };
  return F(() => {
    localStorage.setItem(Q.FONT_SIZE, a.toString());
  }, [a]), F(() => {
    localStorage.setItem(Q.FONT_STYLE, i);
  }, [i]), {
    backgroundColor: t,
  ...
  onIncreaseFontSize: d,
  onResetFontSize: u,
  onOpenChange: x
}) => {
  const h = (l) => t === l, o = (l) => a === l;
  ...
  onColorChange: s,
  onFontStyleChange: i,
  currentFontSizeIndex: p,
  onDecreaseFontSize: d,
  onIncreaseFontSize: u,
  onResetFontSize: x,
  onOpenChange: h
}) => /* @__PURE__ */ n.jsxs(In, { modal: !1, onOpenChange: h, children: [
  /* @__PURE__ */ n.jsx(Pn, { asChild: !0, children: /* @__PURE__ */ n.jsx(M, { className: `size-9 rounded-full ${P[t].button}`, variant: "ghost", children: /* @__PURE__ */ n.jsx(Gn.Typography, { className: "size-[18px]!" }) }) }),
  /* @__PURE__ */ n.jsx(Fn, { align: "end", className: "w-[224px]", onCloseAutoFocus: (o) => o.preventDefault(), onOpenAutoFocus: (o) => o.preventDefault(), children: /* @__PURE__ */ n.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ n.jsxs("div", { className: "flex items-center justify-between gap-[6px]", children: [
      /* @__PURE__ */ n.jsx(
        M,
        {
          className: `h-7 flex-1 rounded-[6px] bg-gray-200 p-0 text-[1.1rem] text-black hover:bg-gray-300 dark:bg-gray-950 dark:text-white dark:hover:bg-gray-900 [&_svg]:size-[14px] ${r("SYSTEM") ? "outline outline-2 outline-green" : ""}`,
          variant: "secondary",
          onClick: () => s("SYSTEM"),
          children: "Auto"
        }
      ...
      /* @__PURE__ */ n.jsx(
        M,
        {
          className: `h-7 flex-1 rounded-[6px] bg-black p-0 hover:bg-black dark:border dark:border-gray-950 ${r("DARK") ? "outline outline-2 outline-green" : ""}`,
          onClick: () => s("DARK")
        }
      )
    ] }),
    /* @__PURE__ */ n.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ n.jsxs(
        M,
        {
          className: `flex h-auto w-full flex-col gap-1 rounded-[6px] bg-gray-200 text-black hover:bg-gray-300 dark:bg-gray-950 dark:text-white dark:hover:bg-gray-900 ${a("sans") && "outline outline-2 outline-green"}`,
          variant: "secondary",
          onClick: () => i("sans"),
          children: [
      ...
      /* @__PURE__ */ n.jsxs(
        M,
        {
          className: `flex h-auto w-full flex-col gap-1 rounded-[6px] bg-gray-200 text-black hover:bg-gray-300 dark:bg-gray-950 dark:text-white dark:hover:bg-gray-900 ${a("serif") && "outline outline-2 outline-green"}`,
          variant: "secondary",
          onClick: () => i("serif"),
          children: [
  ...
  iframeElement: r,
  modalRef: a,
  className: s = "visible! absolute inset-y-0 right-7 z-40 hidden lg:block!",
  onOpenChange: i
}) => {
  const [p, d] = w(null), u = Z.useRef(!1), x = (h) => {
    if (!r?.contentDocument)
      return;
    const o = r.contentDocument.getElementById(h);
    o && a.current && (u.current = !0, d(h), a.current.scrollTo({
      top: o.offsetTop - 20,
      behavior: "smooth"
    }), setTimeout(() => {
      u.current = !1;
  ...
  return F(() => {
    if (!r?.contentDocument || t.length <= 1)
      return;
    const h = a.current;
    if (!h)
      return;
    const o = () => {
      if (u.current)
        return;
      const c = r.contentDocument;
      if (!c)
        return;
      const N = h.scrollTop, L = 100, B = t.map((S) => c.getElementById(S.id)).filter((S) => S !== null).map((S) => ({
        id: S.id,
        top: S.offsetTop
      }));
      if (!B.length)
        return;
      const O = B.reduce((S, T) => T.top - L <= N ? T : S);
      d(O?.id || null);
    }, l = () => {
      requestAnimationFrame(o);
    };
    return h.addEventListener("scroll", l), o(), () => {
      h.removeEventListener("scroll", l);
    };
  }, [r, t, a]), t.length <= 1 ? null : /* @__PURE__ */ n.jsx("div", { className: s, children: /* @__PURE__ */ n.jsx("div", { className: "sticky top-1/2 -translate-y-1/2", children: /* @__PURE__ */ n.jsx(
    Te,
    {
      activeHeading: p || "",
      items: t,
  ...
  2: "pl-6",
  3: "pl-10"
}, Te = ({ items: t, activeHeading: r, onItemClick: a, onOpenChange: s }) => {
  const [i, p] = w(!1), d = Z.useRef();
  if (Z.useEffect(() => () => {
    d.current && clearTimeout(d.current);
  }, []), t.length === 0)
    return null;
  const u = (c) => Math.min(c, 3), x = (c) => Oe[u(c)], h = (c) => Re[u(c)], o = () => {
    d.current && clearTimeout(d.current), p(!0), s?.(!0);
  }, l = () => {
    d.current = setTimeout(() => {
      p(!1), s?.(!1);
    }, 100);
  };
  return /* @__PURE__ */ n.jsxs(In, { modal: !1, open: i, onOpenChange: p, children: [
    /* @__PURE__ */ n.jsx(Pn, { asChild: !0, children: /* @__PURE__ */ n.jsx(
      "div",
      {
        className: "absolute top-1/2 right-2 flex -translate-y-1/2 flex-col items-end gap-2 rounded-md p-2 text-base dark:bg-black",
        onMouseEnter: o,
        onMouseLeave: l,
        children: t.map((c) => /* @__PURE__ */ n.jsx(
          "div",
          {
            className: `h-[2px] rounded-sm ${r === c.id ? "bg-black dark:bg-white" : "bg-gray-400 dark:bg-gray-700"} pr-1 transition-all ${x(c.level)}`
          },
          c.id
        ))
      }
        ...
        children: /* @__PURE__ */ n.jsx(
          "nav",
          {
            ...
            children: t.map((c) => /* @__PURE__ */ n.jsx(
              "button",
              {
                className: `line-clamp-2 block w-full cursor-pointer rounded py-1 text-left text-sm leading-tight ${r === c.id ? "text-black dark:text-white" : "text-gray-700 dark:text-gray-600"} hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-grey-950 dark:hover:text-white ${h(c.level)}`,
                type: "button",
                onClick: () => a(c.id),
                children: /* @__PURE__ */ n.jsx("span", { className: "line-clamp-2", children: c.text })
              },
              c.id
            ))
          }
...
`, $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ae
}, Symbol.toStringTag, { value: "Module" })), De = `(function() {
...
`, Be = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: De
}, Symbol.toStringTag, { value: "Module" })), qe = `(function() {
...
`, He = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: qe
}, Symbol.toStringTag, { value: "Module" })), Ue = `(function() {
...
`, We = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ue
}, Symbol.toStringTag, { value: "Module" })), Ke = `.kg-audio-card,
.kg-audio-card * {
    box-sizing: border-box;
}
...
`, Ve = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ke
}, Symbol.toStringTag, { value: "Module" })), Ye = `.kg-blockquote-alt {
  font-size: 1.5em;
  font-style: italic;
  line-height: 1.7em;
  text-align: center;
...
`, Qe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ye
}, Symbol.toStringTag, { value: "Module" })), Ze = `.kg-bookmark-card,
.kg-bookmark-card * {
    box-sizing: border-box;
}
...
.kg-button-card a.kg-btn-accent {
  ...
  __proto__: null,
  default: Xe
}, Symbol.toStringTag, { value: "Module" })), nt = `.kg-callout-card,
.kg-callout-card * {
    box-sizing: border-box;
}
...
.kg-callout-card + .kg-callout-card {
  ...
  __proto__: null,
  default: nt
}, Symbol.toStringTag, { value: "Module" })), tt = `.kg-collection-card {
    width: 100%;
    margin-top: 6vmin;
}
...
@media (min-width: 1280px) {
  ...
  __proto__: null,
  default: tt
}, Symbol.toStringTag, { value: "Module" })), ot = `.kg-cta-card,
.kg-cta-card * {
    box-sizing: border-box;
}
...
`, rt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ot
}, Symbol.toStringTag, { value: "Module" })), it = `.kg-file-card,
.kg-file-card * {
    box-sizing: border-box;
}
...
`, st = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ct
}, Symbol.toStringTag, { value: "Module" })), lt = `.kg-header-card,
.kg-header-card * {
    box-sizing: border-box;
}
...
`, gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: lt
}, Symbol.toStringTag, { value: "Module" })), pt = `.kg-header-card.kg-v2 {
    position: relative;
    padding: 0;
    min-height: initial;
    text-align: initial;
...
`, ut = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: pt
}, Symbol.toStringTag, { value: "Module" })), ht = `.kg-nft-card,
.kg-nft-card * {
    box-sizing: border-box;
}
...
.kg-nft-card p.kg-nft-description {
  ...
  __proto__: null,
  default: ht
}, Symbol.toStringTag, { value: "Module" })), kt = `.kg-product-card,
.kg-product-card * {
    box-sizing: border-box;
}
...
`, ft = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: kt
}, Symbol.toStringTag, { value: "Module" })), bt = `.kg-signup-card {
    position: relative;
}
...
`, xt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: bt
}, Symbol.toStringTag, { value: "Module" })), vt = `.kg-toggle-card,
.kg-toggle-card * {
    box-sizing: border-box;
}
...
`, yt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: vt
}, Symbol.toStringTag, { value: "Module" })), wt = `.kg-transistor-card {
    display: flex;
    justify-content: center;
}
...
`, zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ct
}, Symbol.toStringTag, { value: "Module" })), St = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/js/audio.js": $e, "../../ghost/core/core/frontend/src/cards/js/gallery.js": Be, "../../ghost/core/core/frontend/src/cards/js/toggle.js": He, "../../ghost/core/core/frontend/src/cards/js/video.js": We }), _t = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/css/audio.css": Ve, "../../ghost/core/core/frontend/src/cards/css/blockquote.css": Qe, "../../ghost/core/core/frontend/src/cards/css/bookmark.css": Je, "../../ghost/core/core/frontend/src/cards/css/button.css": Ge, "../../ghost/core/core/frontend/src/cards/css/callout.css": et, "../../ghost/core/core/frontend/src/cards/css/collection.css": at, "../../ghost/core/core/frontend/src/cards/css/cta.css": rt, "../../ghost/core/core/frontend/src/cards/css/file.css": dt, "../../ghost/core/core/frontend/src/cards/css/gallery.css": st, "../../ghost/core/core/frontend/src/cards/css/header.css": gt, "../../ghost/core/core/frontend/src/cards/css/header_v2.css": ut, "../../ghost/core/core/frontend/src/cards/css/nft.css": mt, "../../ghost/core/core/frontend/src/cards/css/product.css": ft, "../../ghost/core/core/frontend/src/cards/css/signup.css": xt, "../../ghost/core/core/frontend/src/cards/css/toggle.css": yt, "../../ghost/core/core/frontend/src/cards/css/transistor.css": jt, "../../ghost/core/core/frontend/src/cards/css/video.css": zt }), Et = Object.values(St).map((t) => t.default).join(`

`), Nt = Object.values(_t).map((t) => t.default).join(`
...
`), It = ({
  ...
  const N = U(null), [L, B] = w(!0), [O, S] = w("0px"), T = document.documentElement.classList.contains("dark") && d === "SYSTEM" || d === "DARK", J = Me(), k = typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(hover: none) and (pointer: coarse)").matches, q = se(() => {
    const g = k ? le(p) : p;
    return ge(g);
  }, [p, k]), W = `
        <html class="has-${T ? "light" : "dark"}-text has-${x}-body ${d === "SEPIA" && "has-sepia-bg"}">
        <head>
            ${J}
            <style>
                :root {
        ...
        <body>
            <header class='gh-article-header gh-canvas'>
                <h1 class='gh-article-title is-title' data-test-article-heading>${D(r)}</h1>
                ${s ? `<p class='gh-article-excerpt'>${D(s)}</p>` : ""}
                <a href="${t && jn(t) ? D(t) : "#"}" target="_blank" rel="noopener noreferrer" class="gh-article-meta">
                    ${i && i.length > 0 ? `
  ...
  return F(() => {
    ...
    g.srcdoc || (g.srcdoc = W);
    const _ = (v) => {
      if (v.data.type === "resize") {
        const f = `${v.data.bodyHeight + 24}px`;
        S(f), g.style.height = f, v.data.isLoaded && B(!1);
      }
    }, j = (v) => {
      if (v.key === "Escape") {
      ...
      const v = g.contentWindow;
      v && v.addEventListener("keydown", j);
    };
    return g.addEventListener("load", A), window.addEventListener("message", _), () => {
      window.removeEventListener("message", _), g.removeEventListener("load", A);
      const v = g.contentWindow;
      v && v.removeEventListener("keydown", j);
    };
  }, [W]), F(() => {
    const g = N.current;
    if (!g)
      return;
    const _ = g.contentDocument || g.contentWindow?.document;
    if (!_)
      return;
    const j = _.documentElement;
    j.style.setProperty("--font-size", u), j.classList.remove("has-sans-body", "has-serif-body"), j.classList.add(`has-${x}-body`), j.classList.remove("has-dark-text", "has-light-text"), j.classList.add(`has-${T ? "light" : "dark"}-text`), d === "SEPIA" ? j.classList.add("has-sepia-bg") : j.classList.remove("has-sepia-bg");
    const A = g.contentWindow;
    if (A && typeof A.resizeIframe == "function")
      A.resizeIframe();
    else {
    ...
    const _ = () => {
      ...
      if (j.length === 0)
        return;
      const A = Math.min(
        ...j.map((f) => parseInt(f.tagName[1]))
      ), v = j.map((f, an) => {
        const X = `heading-${an}`;
        f.id = X;
        const K = parseInt(f.tagName[1]) - A + 1;
        return {
          id: X,
          text: f.textContent || "",
          level: K,
    ...
    return g.addEventListener("load", _), () => g.removeEventListener("load", _);
  }, [h, o]), F(() => {
    l?.(L);
  }, [L, l]), /* @__PURE__ */ n.jsx("div", { className: "w-full pb-6", children: /* @__PURE__ */ n.jsxs("div", { className: "relative -mx-6", children: [
    L && /* @__PURE__ */ n.jsxs("div", { className: "mx-auto mt-6 w-full max-w-[640px] max-lg:px-4", children: [
      /* @__PURE__ */ n.jsxs("div", { className: "mb-6 flex flex-col gap-2", children: [
        /* @__PURE__ */ n.jsx(E, { className: "h-8" }),
        /* @__PURE__ */ n.jsx(E, { className: "h-8 w-full max-w-md" })
      ] }),
      /* @__PURE__ */ n.jsx(E, { className: "mt-2 h-4", count: 4, randomize: !0 }),
      /* @__PURE__ */ n.jsx(E, { className: "mt-8 h-[400px]" }),
      /* @__PURE__ */ n.jsx(E, { className: "mt-2 h-4", containerClassName: "block mt-7 mb-4", count: 8, randomize: !0 })
    ] }),
    /* @__PURE__ */ n.jsx(
      "iframe",
      {
...
}, En = () => /* @__PURE__ */ n.jsx("div", { className: "h-px bg-black/[8%] dark:bg-gray-950" }), tn = /* @__PURE__ */ new Map(), Pt = ({
  postId: t = null,
  onClose: r
}) => {
  const {
    ...
    decreaseFontSize: h,
    resetFontSize: o
  } = Pe(), l = U(null), [c, N] = w(!1), [L, B] = w(!1), [O, S] = w(/* @__PURE__ */ new Set()), [T, J] = w(/* @__PURE__ */ new Set()), [k, q] = w(/* @__PURE__ */ new Set()), [W, g] = w(!1), _ = U(null), j = U(null), {
    post: A,
    processedReplies: v,
    isLoading: f,
    loadMoreChildren: an,
    loadMoreChildReplies: X,
    hasMoreChildren: G,
    hasMoreChildReplies: K
  } = Ce(t ?? "", { includeAncestors: !1 }), gn = A, b = gn?.object, H = gn?.actor, Rn = gn?.object?.metadata?.ghostAuthors, Tn = b?.replyCount ?? 0;
  F(() => {
    if (!G)
      return;
    ...
    const e = l.current;
    if (e)
      return _.current = new IntersectionObserver(async (C) => {
        if (C[0].isIntersecting && G && !W) {
          g(!0);
          try {
            await an();
          } catch (m) {
            console.error("Failed to load more top-level replies:", m);
          } finally {
            g(!1);
          }
        }
        ...
        root: e,
        rootMargin: "200px"
      }), j.current && _.current.observe(j.current), () => {
        _.current && _.current.disconnect();
      };
  }, [G, W, an]);
  function pn() {
  ...
  function Mn(e) {
    S((C) => {
      const m = new Set(C);
      return m.has(e) ? m.delete(e) : (m.add(e), J((z) => {
        const R = new Set(z);
        return R.add(e), R;
      })), m;
    });
  }
  async function An(e, C) {
    if (!k.has(e)) {
      q((m) => new Set(m).add(e));
      try {
        X && await X(C);
      } catch (m) {
        console.error("Failed to load more replies for chain:", m);
      } finally {
        q((m) => {
          const z = new Set(m);
          return z.delete(e), z;
  ...
  const $n = () => {
  }, Dn = U(null), Bn = "904px", V = "640px", [bn, qn] = w(0), [nn, Hn] = w(!0), [un] = ee(qn, 100), xn = 1;
  F(() => {
    const e = l.current, C = document.getElementById("object-content"), m = () => {
      if (nn || !e || !C)
        return;
      const R = C.getBoundingClientRect(), Y = e.getBoundingClientRect();
      if (R.height <= Y.height) {
        un(100);
        return;
      }
      const $ = Math.max(0, Y.top - R.top), y = C.offsetHeight - e.offsetHeight, I = Math.min(Math.max($ / y * 100, 0), 100), cn = Math.round(I / xn) * xn;
      un(cn);
    };
    if (nn)
      return;
    ...
    return C && z.observe(C, {
      ...
      subtree: !0,
      characterData: !0
    }), e?.addEventListener("scroll", m), m(), () => {
      e?.removeEventListener("scroll", m), z.disconnect();
    };
  }, [nn, un]);
  const [on, Un] = w([]), [Wn, Kn] = w(null), [rn, Vn] = w(null), Yn = yn((e) => {
    Un(e);
  }, []), Qn = yn((e) => {
    Vn(e);
  }, []);
  F(() => {
    if (!rn?.contentDocument || !on.length)
      return;
    const C = setTimeout(() => {
      const m = l.current;
      if (!m)
        return;
      const z = () => {
        const R = rn.contentDocument;
        if (!R || !R.documentElement)
          return;
        const Y = m.scrollTop, en = on.map((I) => R.getElementById(I.id)).filter((I) => I !== null).map((I) => ({
          element: I,
          id: I.id,
          top: I.offsetTop
        }));
      ...
      return m.addEventListener("scroll", z), z(), () => {
  ...
  return F(() => {
    const e = l.current;
    return () => {
      e && t && tn.set(t, e.scrollTop);
    };
  }, [t]), F(() => {
    if (!nn && !f && t && l.current) {
      const e = tn.get(t);
      e !== void 0 && e > 0 && setTimeout(() => {
        l.current && (l.current.scrollTop = e);
      }, 100);
    }
  }, [nn, f, t]), f ? /* @__PURE__ */ n.jsx("div", { className: `max-h-full overflow-auto rounded-md ${a === "DARK" && "dark"} ${(a === "LIGHT" || a === "SEPIA") && "light"} ${P[a].background}`, children: /* @__PURE__ */ n.jsx("div", { className: "flex h-full flex-col", children: /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
    /* @__PURE__ */ n.jsx("div", { className: `sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${P[a].background} ${P[a].border}`, children: /* @__PURE__ */ n.jsxs(
      "div",
      {
        className: "grid w-full px-8 max-lg:px-4",
        style: {
          gridTemplateColumns: `1fr minmax(0,${V}) 1fr`
        },
        children: [
          /* @__PURE__ */ n.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ n.jsx(hn, { className: P[a].button, onClick: r }) }),
          /* @__PURE__ */ n.jsxs("div", { className: "col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden", children: [
            /* @__PURE__ */ n.jsx(E, { className: "size-10 rounded-full" }),
            /* @__PURE__ */ n.jsxs("div", { className: "grow pt-1", children: [
              /* @__PURE__ */ n.jsx(E, { className: "w-full" }),
              /* @__PURE__ */ n.jsx(E, { className: "w-2/3" })
            ] })
          ] }),
  ...
  ] }) }) }) : A ? /* @__PURE__ */ n.jsx("div", { ref: l, className: `max-h-full overflow-auto rounded-md ${a === "DARK" && "dark"} ${(a === "LIGHT" || a === "SEPIA") && "light"} ${P[a].background}`, "data-scrollable-container": !0, children: /* @__PURE__ */ n.jsx(n.Fragment, { children: /* @__PURE__ */ n.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ n.jsxs("div", { className: "col-[2/3] mx-auto flex w-full items-center justify-between gap-3 max-md:hidden", children: [
              /* @__PURE__ */ n.jsx(te, { actor: H, isCurrentUser: b.authored, children: /* @__PURE__ */ n.jsxs("div", { className: "flex cursor-pointer items-center gap-3", children: [
                /* @__PURE__ */ n.jsx("div", { className: "relative z-10 pt-0.5", children: /* @__PURE__ */ n.jsx(ae, { author: H }) }),
                /* @__PURE__ */ n.jsxs("div", { className: "relative z-10 mt-0.5 flex min-w-0 cursor-pointer flex-col overflow-visible text-[1.5rem]", onClick: (e) => re(H, dn, e), children: [
                  /* @__PURE__ */ n.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ n.jsx("span", { className: "min-w-0 truncate font-semibold whitespace-nowrap text-black hover:underline dark:text-white", children: f ? /* @__PURE__ */ n.jsx(E, { className: "w-20" }) : H.name }) }),
                  /* @__PURE__ */ n.jsxs("div", { className: "flex w-full", children: [
                    !f && /* @__PURE__ */ n.jsx("span", { className: 'truncate text-gray-700 after:mx-1 after:font-normal after:text-gray-700 after:content-["·"]', children: wn(H) }),
                    /* @__PURE__ */ n.jsx("span", { className: "text-gray-700", children: f ? /* @__PURE__ */ n.jsx(E, { className: "w-[120px]" }) : oe(b, !b.authored) })
                  ] })
                ] })
              ] }) }),
              !b.authored && !f && /* @__PURE__ */ n.jsx(
                ie,
                {
      ...
      /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
        ...
        !f && /* @__PURE__ */ n.jsx("div", { className: "grow overflow-y-auto", children: /* @__PURE__ */ n.jsxs("div", { className: "mx-auto px-6 pt-5 pb-10", style: { maxWidth: Bn }, children: [
          /* @__PURE__ */ n.jsxs("div", { className: "flex flex-col items-center pb-8", id: "object-content", children: [
            /* @__PURE__ */ n.jsx(
              It,
              {
                ...
                isPopoverOpen: c || L,
                postUrl: b?.url || "",
                onHeadingsExtracted: Yn,
                onIframeLoad: Qn,
                onLoadingChange: Hn
              }
            ),
            /* @__PURE__ */ n.jsx("div", { className: "-ml-3 w-full", style: { maxWidth: V }, children: /* @__PURE__ */ n.jsx(
              de,
              {
                actor: H,
                commentCount: Tn,
                ...
                object: b,
                repostCount: b.repostCount ?? 0,
                onLikeClick: $n
              }
            ) })
          ] }),
          b.type === "Tombstone" && /* @__PURE__ */ n.jsx(ze, { last: !0 }),
          /* @__PURE__ */ n.jsxs("div", { className: "mx-auto w-full border-t border-black/[8%] dark:border-gray-950", style: { maxWidth: V }, children: [
            /* @__PURE__ */ n.jsx(
              Se,
              {
                object: b
          ...
          f && /* @__PURE__ */ n.jsx(mn, { size: "lg" }),
          /* @__PURE__ */ n.jsxs("div", { ref: Dn, className: "mx-auto w-full", style: { maxWidth: V }, children: [
            v.map((e, C) => {
              const m = C === v.length - 1, z = e.mainReply.id, R = O.has(z), Y = T.has(z), en = k.has(z), $ = e.chain.length > 0;
              return /* @__PURE__ */ n.jsxs(Z.Fragment, { children: [
                /* @__PURE__ */ n.jsx(
                  sn,
                  {
                    ...
                    onClick: () => {
                      const y = l.current;
                      y && t && tn.set(t, y.scrollTop), dn(`/notes/${encodeURIComponent(e.mainReply.id)}`);
                    },
                    onDelete: pn
                  }
                ),
                $ && e.chain[0] && /* @__PURE__ */ n.jsx(
                  sn,
                  {
                    ...
                    onClick: () => {
                      const y = l.current;
                      y && t && tn.set(t, y.scrollTop), dn(`/notes/${encodeURIComponent(e.chain[0].id)}`);
                    },
                    onDelete: pn
                  },
                  e.chain[0].id
                ),
                $ && R && e.chain.slice(1).map((y, I) => {
                  const cn = I === e.chain.slice(1).length - 1, Zn = K && K(C), Jn = cn && Zn;
                  return /* @__PURE__ */ n.jsx(
                    sn,
                    {
                      actor: y.actor,
                      allowDelete: y.object.authored,
                      commentCount: y.object.replyCount ?? 0,
                      isChainContinuation: !0,
                      isPending: ln(y.id),
                      last: cn && !Jn,
                      layout: "reply",
                      likeCount: y.object.likeCount ?? 0,
                      object: y.object,
                      parentId: b.id,
                      repostCount: y.object.repostCount ?? 0,
                      type: "Note",
                      onClick: () => {
                        const vn = l.current;
                        vn && t && tn.set(t, vn.scrollTop), dn(`/notes/${encodeURIComponent(y.id)}`);
                      },
                      onDelete: pn
                    },
                    y.id
                ...
                $ && e.chain.length > 1 && !R && /* @__PURE__ */ n.jsx(
                  zn,
                  {
                    variant: "expand",
                    onClick: () => Mn(z)
            ...
            W && /* @__PURE__ */ n.jsx("div", { className: "flex flex-col items-center justify-center text-center", children: /* @__PURE__ */ n.jsx(mn, { size: "md" }) })
          ] }),
          G && /* @__PURE__ */ n.jsx("div", { ref: j, className: "h-1" })
        ] }) })
      ] })
    ] }),
    !f && /* @__PURE__ */ n.jsxs("div", { className: "pointer-events-none visible! sticky bottom-0 hidden items-end justify-between px-10 pb-[42px] lg:flex!", children: [
      /* @__PURE__ */ n.jsx("div", { className: "pointer-events-auto text-gray-600", children: ce(b.content ?? "") }),
  ...
  ] }) }) }) : /* @__PURE__ */ n.jsx("div", { className: `max-h-full overflow-auto rounded-md ${a === "DARK" && "dark"} ${(a === "LIGHT" || a === "SEPIA") && "light"} ${P[a].background}`, children: /* @__PURE__ */ n.jsx("div", { className: "flex h-full flex-col", children: /* @__PURE__ */ n.jsx("div", { className: "relative flex-1", children: /* @__PURE__ */ n.jsx("div", { className: `sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${P[a].background} ${P[a].border}`, children: /* @__PURE__ */ n.jsxs(
    "div",
    {
      className: "grid w-full px-8 max-lg:px-4",
      style: {
  ...
  const u = Ln(), { canGoBack: x, goBack: h } = pe(), [o, l] = w(!1), c = ue(), { topicsQuery: N } = he(), { data: L } = N, B = L && L.topics.length > 0;
  F(() => {
    l(!!c.postId);
  }, [c.postId]);
  const O = U(null), S = U(null), T = U(null);
  F(() => (O.current && O.current.disconnect(), O.current = new IntersectionObserver((k) => {
    k[0].isIntersecting && i && !p && s();
  }), S.current && O.current.observe(S.current), T.current && O.current.observe(T.current), () => {
    O.current && O.current.disconnect();
  }), [i, p, s]);
  const J = Math.max(0, Math.floor(r.length * 0.75) - 1);
  return /* @__PURE__ */ n.jsxs(me, { children: [
    B && /* @__PURE__ */ n.jsx(_e, { currentTopic: a, excludeTopics: ["top"], onTopicChange: d }),
    /* @__PURE__ */ n.jsx("div", { className: "flex w-full flex-col", children: /* @__PURE__ */ n.jsx("div", { className: "w-full", children: r.length > 0 ? /* @__PURE__ */ n.jsx("div", { className: "my-4", children: /* @__PURE__ */ n.jsx("div", { className: "mx-auto flex min-h-[calc(100dvh_-_117px)] items-start gap-11", children: /* @__PURE__ */ n.jsx("div", { className: "flex w-full min-w-0 flex-col items-center", children: /* @__PURE__ */ n.jsxs("div", { className: "flex w-full min-w-0 flex-col items-start", children: [
          ...
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ n.jsx(
                ...
                {
                  actor: k.actor,
                  allowDelete: k.object.authored,
                  commentCount: k.object.replyCount ?? 0,
                  isLoading: t,
                  isPending: ln(k.id),
                  layout: "inbox",
                  likeCount: k.object.likeCount ?? 0,
                  object: k.object,
                  repostCount: k.object.repostCount ?? 0,
                  type: k.type,
                  onClick: () => {
                    u(`/reader/${encodeURIComponent(k.id)}`);
                  }
                }
              ),
              q < r.length - 1 && /* @__PURE__ */ n.jsx(Ee, {}),
              q === J && /* @__PURE__ */ n.jsx("div", { ref: S, className: "h-1" })
            ]
          },
          `${k.id}-${k.type}-${q}`
        )),
        p && /* @__PURE__ */ n.jsx("li", { className: "flex flex-col items-center justify-center gap-4 text-center", children: /* @__PURE__ */ n.jsx(mn, { size: "md" }) })
      ] }),
      /* @__PURE__ */ n.jsx("div", { ref: T, className: "h-1" })
      ...
      kn,
      {
        actions: B ? /* @__PURE__ */ n.jsx(M, { onClick: () => u("/explore"), children: "Find accounts to follow →" }) : /* @__PURE__ */ n.jsx(M, { asChild: !0, children: /* @__PURE__ */ n.jsx("a", { href: "https://explore.ghost.org/social-web", rel: "noopener noreferrer", target: "_blank", children: "Find accounts to follow →" }) }),
    ...
    /* @__PURE__ */ n.jsx(
      ke,
      {
        ...
        children: /* @__PURE__ */ n.jsxs(fe, { className: "inset-y-3 h-[calc(100vh-24px)] w-screen max-w-[calc(100vw-24px)] animate-none! p-0 focus:outline-hidden dark:bg-gray-950", children: [
          /* @__PURE__ */ n.jsxs(be, { className: "hidden", children: [
            /* @__PURE__ */ n.jsx(xe, { children: "Reader" }),
            /* @__PURE__ */ n.jsx(ve, { children: "Ghost reader for long form articles" })
          ] }),
          c.postId && /* @__PURE__ */ n.jsx(Pt, { postId: c.postId, onClose: () => {
            x ? h() : u("/reader");
          } })
        ] })
      }
  ...
  const [t, r] = w("following"), { inboxQuery: a } = ye({ enabled: t === "following" }), { discoveryFeedQuery: s } = we({ enabled: t !== "following", topic: t }), i = t === "following" ? a : s, { data: p, error: d, fetchNextPage: u, hasNextPage: x, isFetchingNextPage: h, isLoading: o } = i, l = d && Cn(d) && d.statusCode === 404 && t !== "following";
  if (d && Cn(d) && !l)
    return /* @__PURE__ */ n.jsx(je, { errorCode: d.code, statusCode: d.statusCode });
  const c = l ? [] : p?.pages.flatMap((N) => N.posts) ?? Array.from({ length: 5 }, (N, L) => ({ id: `placeholder-${L}`, object: {} }));
  return /* @__PURE__ */ n.jsx(
    Ft,
    {
      activities: c,
...
//# sourceMappingURL=index-BRXTYNc0.mjs.map
