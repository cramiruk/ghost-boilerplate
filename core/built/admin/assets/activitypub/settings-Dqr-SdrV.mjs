import { bN as u, bC as b, aZ as e, a0 as m, D as v, J as y, t as N, E as k, H as S, I as w, w as j, P as C, bd as E, az as P, a5 as H } from "./index-B0iXXgvy.mjs";
import { E as D } from "./edit-profile-Ck2RrCzp.mjs";
const I = ({ account: s, className: r = "" }) => {
  const [h, t] = u(!1), a = b();
  return /* @__PURE__ */ e.jsxs("div", { className: `flex flex-col ${r}`, children: [
    ...
    /* @__PURE__ */ e.jsxs(c, { href: "https://ghost.org/help/social-web/", withHover: !0, children: [
      ...
      /* @__PURE__ */ e.jsx(l, { children: /* @__PURE__ */ e.jsx(C, { size: 18 }) })
    ] })
  ] });
...
//# sourceMappingURL=settings-Dqr-SdrV.mjs.map
