import { Q as g, z as y } from "./index-cYbhPZer.mjs";
import { e as b, b as S, d as E } from "./hooks-DxTWmWfO.mjs";
const D = ({ status: e }) => {
  switch (e) {
    case "active":
...
function C() {
  ...
  h = r, r.default = r, r.createFromTime = function(t) {
    return t = parseInt(t, 10) % 4294967295, new r(A(8, t) + "0000000000000000");
  ...
  var v = Symbol && Symbol.for && /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") || "inspect";
  return r.prototype[v] = function() {
    return "ObjectID(" + this + ")";
  }, r.prototype.toJSON = r.prototype.toHexString, r.prototype.toString = r.prototype.toHexString, h;
}
var O = C();
const j = /* @__PURE__ */ y(O), W = 20, p = "AutomationsResponseType", k = E({
  dataType: p,
  path: "/automations/"
}), L = b({
  dataType: p,
...
}), x = () => j().toHexString(), $ = JSON.stringify({
  root: {
    children: [],
    direction: null,
    format: "",
...
}, T = (e, n, c) => e.edges.some((s) => s.source_action_id === n && s.target_action_id === c), _ = ({ detail: e, action: n, anchor: c }) => {
  const { previousActionId: s, nextActionId: i } = c;
  if (s !== void 0 && F(e, s), i !== void 0 && F(e, i), s === void 0 && i === void 0 && e.actions.length > 0)
    throw new Error("spliceAction: anchor is required when inserting into a non-empty automation");
  if (s !== void 0 && i !== void 0 && !T(e, s, i))
...
}, V = ({ detail: e, anchor: n }) => _({ detail: e, action: M(), anchor: n }), U = ({ detail: e, anchor: n }) => _({ detail: e, action: H(), anchor: n }), q = ({ detail: e, actionId: n, waitHours: c }) => {
...
//# sourceMappingURL=automations-TIrlBsPd.mjs.map
