import { h as X, n as Y, p as h, m as y, b as D, d as m, a as _, P as Z, g as J, l as ee, R as te, o as oe, F as ae, D as ne, i as se, f as re } from "./check-Bk1CoFjE.mjs";
import { aj as g, Q as s, a5 as ie, x as i, C as le, a8 as P, S as ce, i as p } from "./index-cYbhPZer.mjs";
const de = [
  ["path", { d: "M18 6 6 18", key: "1bl5f8" }],
  ["path", { d: "m6 6 12 12", key: "d8bk6v" }]
], Ae = X("x", de);
var v = "Dialog", [O, Te] = J(v), [ue, d] = O(v), R = (e) => {
  const {
    __scopeDialog: t,
    children: o,
    open: r,
...
var b = "DialogPortal", [ge, T] = O(b, {
  ...
  return /* @__PURE__ */ s.jsx(ge, { scope: t, forceMount: o, children: le.map(r, (c) => /* @__PURE__ */ s.jsx(_, { present: o || a.open, children: /* @__PURE__ */ s.jsx(Z, { asChild: !0, container: n, children: c }) })) });
};
M.displayName = b;
...
const Fe = Ce, ke = he, _e = ye, Q = i(({ className: e, ...t }, o) => /* @__PURE__ */ s.jsx(
  B,
  {
    ref: o,
    className: p(
...
//# sourceMappingURL=dialog-DTGtFy_7.mjs.map
