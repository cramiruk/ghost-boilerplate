import { h as i } from "./check-Bk1CoFjE.mjs";
import { T as c, r as f } from "./index-cYbhPZer.mjs";
const D = [
  [
    "path",
    {
...
], v = i("thumbs-up", Y), k = (a) => a.format("YYYY-MM-DD"), w = (a) => {
  if (!a.length)
    return { min: 0, max: 1 };
...
//# sourceMappingURL=app-utils-CJzAPXLk.mjs.map
