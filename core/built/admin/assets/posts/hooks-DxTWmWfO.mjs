import { b as f1, _ as Q, U as R1, K as r1, N as n1, a1 as Q1, q as E1, d as I1, Y as s1, J as F1, V as P, H as i1, G as Z1, E as X1, B as U1, Z as G1, a6 as p1, k as v1, a8 as H, ah as J, al as k1, a5 as B, X as C1, W as N1, l as e, h as w1, Q as L, R as q1, F as K1, a9 as $, an as Y1, e as J1, a2 as _1, f as $1, ae as b1 } from "./index-cYbhPZer.mjs";
class L1 extends f1 {
  constructor(o, r) {
  ...
  getOptimisticResult(o) {
    ...
    return te(this, n, o) && (this.currentResult = n, this.currentResultOptions = this.options, this.currentResultState = this.currentQuery.state), n;
  }
  getCurrentResult() {
  ...
  executeFetch(o) {
    ...
    return o != null && o.throwOnError || (r = r.catch(R1)), r;
  }
  updateStaleTimeout() {
    if (this.clearStaleTimeout(), r1 || this.currentResult.isStale || !n1(this.options.staleTime))
      return;
    const r = Q1(this.currentResult.dataUpdatedAt, this.options.staleTime) + 1;
  ...
  updateRefetchInterval(o) {
    this.clearRefetchInterval(), this.currentRefetchInterval = o, !(r1 || this.options.enabled === !1 || !n1(this.currentRefetchInterval) || this.currentRefetchInterval === 0) && (this.refetchIntervalId = setInterval(() => {
      (this.options.refetchIntervalInBackground || E1.isFocused()) && this.executeFetch();
  ...
  createResult(o, r) {
    ...
    if (r._optimisticResults) {
      const b = this.hasListeners(), F = !b && l1(o, r), V1 = b && a1(o, n, r, i);
      (F || V1) && (k = I1(o.options.networkMode) ? "fetching" : "paused", g || (v = "loading")), r._optimisticResults === "isRestoring" && (k = "idle");
    }
  ...
  onQueryUpdate(o) {
    const r = {};
    o.type === "success" ? r.onSuccess = !o.manual : o.type === "error" && !F1(o.error) && (r.onError = !0), this.updateResult(r), this.hasListeners() && this.updateTimers();
  }
  notify(o) {
    P.batch(() => {
      if (o.onSuccess) {
...
function l1(t, o) {
  return ee(t, o) || t.state.dataUpdatedAt > 0 && U(t, o, o.refetchOnMount);
}
function U(t, o, r) {
  if (o.enabled !== !1) {
...
class oe extends L1 {
  ...
  createResult(o, r) {
    ...
    return {
      ...
      hasNextPage: X1(r, (a = d.data) == null ? void 0 : a.pages),
      hasPreviousPage: Z1(r, (c = d.data) == null ? void 0 : c.pages),
...
let re = class extends f1 {
  ...
  updateResult() {
    const o = this.currentMutation ? this.currentMutation.state : U1(), r = o.status === "loading", n = {
      ...o,
      isLoading: r,
      isPending: r,
...
var u1;
function se() {
  return u1 || (u1 = 1, Z.exports = ne()), Z.exports;
}
var ie = se();
const m1 = ie.useSyncExternalStore, j1 = /* @__PURE__ */ v1(!1), le = () => p1(j1);
j1.Provider;
function ae() {
  let t = !1;
  return {
...
const ce = /* @__PURE__ */ v1(ae()), ue = () => p1(ce);
function y1(t, o) {
...
const de = (t, o) => {
  ...
  useErrorBoundary: r,
  query: n
}) => t.isError && !o.isReset() && !t.isFetching && y1(r, [t.error, n]), fe = (t) => {
  t.suspense && (typeof t.staleTime != "number" && (t.staleTime = 1e3), typeof t.cacheTime == "number" && (t.cacheTime = Math.max(t.cacheTime, 1e3)));
}, pe = (t, o) => t.isLoading && t.isFetching && !o, ve = (t, o, r) => t?.suspense && pe(o, r), ke = (t, o, r) => o.fetchOptimistic(t).then(({
  data: n
}) => {
...
function M1(t, o) {
  const r = J({
    context: t.context
  }), n = le(), i = ue(), s = r.defaultQueryOptions(t);
  s._optimisticResults = n ? "isRestoring" : "optimistic", s.onError && (s.onError = P.batchCalls(s.onError)), s.onSuccess && (s.onSuccess = P.batchCalls(s.onSuccess)), s.onSettled && (s.onSettled = P.batchCalls(s.onSettled)), fe(s), de(s, i), he(i);
...
function Ce(t, o, r) {
  ...
  const l = m1(B((c) => s.subscribe(P.batchCalls(c)), [s]), () => s.getCurrentResult(), () => s.getCurrentResult()), a = B((c, d) => {
    s.mutate(c, d).catch(we);
  }, [s]);
  if (l.error && y1(s.options.useErrorBoundary, [l.error]))
    throw l.error;
  return {
    ...l,
    mutate: a,
...
let Fo = { data: "" }, Zo = (t) => {
  ...
  if (typeof t == "object") {
    let o = "";
    for (let r in t) o += r + x1(t[r]);
    return o;
  }
  return t;
}, Go = (t, o, r, n, i) => {
  let s = x1(t), l = M[s] || (M[s] = ((c) => {
    let d = 0, u = 11;
  ...
  if (!M[l]) {
    let c = s !== t ? t : ((d) => {
      let u, h, g = [{}];
      for (; u = Xo.exec(d.replace(Uo, "")); ) u[4] ? g.shift() : u[3] ? (h = u[3].replace(h1, " ").trim(), g.unshift(g[0][h] = g[0][h] || {})) : g[0][u[1]] = u[2].replace(h1, " ").trim();
      return g[0];
    })(t);
...
function E(t) {
  ...
  return Go(r.unshift ? r.raw ? No(r, [].slice.call(arguments, 1), o.p) : r.reduce((n, i) => Object.assign(n, i && i.call ? i(o.p) : i), {}) : r, Zo(o.target), o.g, o.o, o.k);
}
let S1, G, N;
E.bind({ g: 1 });
let j = E.bind({ k: 1 });
...
function x(t, o) {
  ...
  return function() {
    ...
    function i(s, l) {
      ...
      let d = t;
      return t[0] && (d = a.as || t, delete a.as), N && d[0] && N(a), S1(d, a);
    }
    return i;
  };
}
var Ko = (t) => typeof t == "function", q = (t, o) => Ko(t) ? t(o) : t, Yo = /* @__PURE__ */ (() => {
  let t = 0;
  return () => (++t).toString();
})(), Jo = /* @__PURE__ */ (() => {
  let t;
  ...
  switch (o.type) {
    ...
    case 2:
      let { toast: n } = o;
      return O1(t, { type: t.toasts.find((l) => l.id === n.id) ? 1 : 0, toast: n });
    case 3:
      let { toastId: i } = o;
...
}, er = [], tr = { toasts: [], pausedAt: void 0, settings: { toastLimit: $o } }, O = {}, B1 = (t, o = P1) => {
  O[o] = O1(O[o] || tr, t), er.forEach(([r, n]) => {
    r === o && n(O[o]);
  });
}, H1 = (t) => Object.keys(O).forEach((o) => B1(t, o)), or = (t) => Object.keys(O).find((o) => O[o].toasts.some((r) => r.id === t)), t1 = (t = P1) => (o) => {
  B1(o, t);
}, rr = (t, o = "blank", r) => ({ createdAt: Date.now(), visible: !0, dismissed: !1, type: o, ariaProps: { role: "status", "aria-live": "polite" }, message: t, pauseDuration: 0, ...r, id: r?.id || Yo() }), D = (t) => (o, r) => {
  let n = rr(o, t, r);
  return t1(n.toasterId || or(n.id))({ type: 2, toast: n }), n.id;
}, p = (t, o) => D("blank")(t, o);
p.error = D("error");
p.success = D("success");
p.loading = D("loading");
...
`, kr = ({ toast: t }) => {
  ...
  return o !== void 0 ? typeof o == "string" ? e(vr, null, o) : o : r === "blank" ? null : e(fr, null, e(cr, { ...n }), r !== "loading" && e(gr, null, r === "error" ? e(lr, { ...n }) : e(hr, { ...n })));
}, Cr = (t) => `
...
`, _r = "0%{opacity:0;} 100%{opacity:1;}", br = "0%{opacity:1;} 100%{opacity:0;}", Lr = x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`, jr = (t, o) => {
  let r = t.includes("top") ? 1 : -1, [n, i] = Jo() ? [_r, br] : [Cr(r), wr(r)];
  return { animation: o ? `${j(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${j(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)` };
};
q1(({ toast: t, position: o, style: r, children: n }) => {
  let i = t.height ? jr(t.position || o || "top-center", t.visible) : { opacity: 0 }, s = e(kr, { toast: t }), l = e(mr, { ...t.ariaProps }, q(t.message, t));
  return e(Lr, { className: t.className, style: { ...i, ...r, ...t.style } }, typeof n == "function" ? n({ icon: s, message: l }) : e(K1, null, s, l));
});
qo(e);
E`
  z-index: 9999;
...
function T1() {
  yr.remove(), _1.dismiss();
}
function g1(t) {
  T1(), document.querySelector(".toast-outlet-react-hot-toast") ? Ar({
    message: t,
    type: "error"
  }) : _1.error(t);
}
const o1 = () => {
  ...
  return B((r, { withToast: n = !0 } = {}) => {
    console.error(r), t && Y1((i) => {
      r instanceof m && r.response && (i.setTag("api_url", r.response.url), i.setTag("api_response_status", r.response.status)), J1(r);
    }), n && (r instanceof m && r.response?.status === 418 ? T1() : r instanceof m ? g1(Tr(r, r.message)) : g1("Something went wrong, please try again."));
  }, [t]);
};
function Wr() {
...
const Dr = async (t) => {
  ...
  if (t.status === 415)
    throw new Or(t, await t.text());
  if (t.status === 413)
    throw new Pr(t, await t.text());
  if (t.ok)
    return t.status === 204 ? void 0 : t.headers.get("content-type")?.includes("text/csv") ? await t.text() : await t.json();
  {
    ...
    throw o.errors?.[0]?.type === "VersionMismatchError" ? new xr(t, o) : o.errors?.[0]?.type === "ValidationError" ? new Y(t, o) : o.errors?.[0]?.type === "NoPermissionError" ? new Y(t, o) : o.errors?.[0]?.type === "ThemeValidationError" ? new Br(t, o) : o.errors?.[0]?.type === "HostLimitError" ? new Hr(t, o) : o.errors?.[0]?.type === "EmailError" ? new zr(t, o) : new z(t, o);
  }
}, Vr = (t) => {
...
`) || [];
  ...
  return o;
}, Rr = (t) => new Response(t.response, {
  status: t.status,
  statusText: t.statusText,
  headers: Vr(t)
}), Qr = (t, o, { method: r, headers: n, credentials: i, body: s, signal: l }) => new Promise((a, c) => {
  const d = () => {
  ...
  return B(async (r, {
    ...
    }, _ = d ? Qr.bind(null, d) : fetch, T = a ? setTimeout(() => u.abort(), a) : void 0;
    try {
      for (; g === 0 || c; )
        try {
          const C = await _(r, h);
          ...
          if (g !== 0 && o && $1("Request failed after multiple attempts", { extra: R() }), C && typeof C == "object" && "name" in C && C.name === "AbortError")
            throw new Sr();
          let y = C;
...
}, { apiRoot: Er, activityPubRoot: Ir } = Wr(), W = (t, o = {}, r = !1) => {
  const n = r ? Ir : Er, i = new URL(`${n}${t}`, window.location.origin);
  return i.search = new URLSearchParams(o).toString(), i.toString();
}, Fr = "UsersResponseType", W1 = W("/users/me/", { include: "roles" }), Zr = [Fr, W1], Xr = () => {
  const t = I(), o = o1(), r = A1({
    queryKey: Zr,
    queryFn: () => t(W1),
    select: (n) => n.users[0]
...
}, Ur = (t) => ({ searchParams: o, ...r } = {}) => {
  const n = W(t.path, o || t.defaultSearchParams, t?.useActivityPub), i = I(), s = o1(), l = D1(t.permissions), a = A1({
    ...r,
...
}, Kr = (t) => ({ searchParams: o, getNextPageParams: r, ...n } = {}) => {
  const i = I(), s = o1(), l = D1(t.permissions), a = r || t.defaultNextPageParams || (() => ({})), c = _e({
    ...n,
  ...
  }), d = b1(() => c.data && t.returnData(c.data), [c.data]);
  return H(() => {
...
}, Yr = (t) => (o, { searchParams: r, ...n } = {}) => Ur({ ...t, path: t.path(o) })({ searchParams: r || t.defaultSearchParams, ...n }), Gr = ({ fetchApi: t, path: o, payload: r, searchParams: n, options: i }) => {
...
}, Jr = ({ path: t, searchParams: o, defaultSearchParams: r, updateQueries: n, invalidateQueries: i, ...s }) => () => {
  ...
  return Ce({
    mutationFn: (g) => Gr({ fetchApi: l, path: t(g), payload: g, searchParams: o?.(g) || r, options: s }),
    onSuccess: h
  });
};
export {
...
//# sourceMappingURL=hooks-DxTWmWfO.mjs.map
