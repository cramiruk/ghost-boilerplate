import { x as l, Q as r, aj as G, a8 as L, a6 as m, i as p, k as z, n as y } from "./index-cYbhPZer.mjs";
import { n as K, b as x, p as B, d as T, g as q, a as H } from "./check-Bk1CoFjE.mjs";
import { F as O, r as Q, I as J, E as j, n as U } from "./skeleton-BLfZp8N_.mjs";
var h = "Tabs", [W] = q(h, [
  j
]), I = j(), [X, N] = W(h), _ = l(
  (t, a) => {
...
w.displayName = V;
var k = "TabsTrigger", A = l(
  (t, a) => {
    const { __scopeTabs: n, value: e, disabled: s = !1, ...d } = t, o = N(k, n), u = I(n), f = M(o.baseId, e), v = P(o.baseId, e), c = e === o.value;
    return /* @__PURE__ */ r.jsx(
      J,
      {
        asChild: !0,
...
var F = _, R = w, C = A, S = E;
const b = z("segmented"), Y = l(({ variant: t = "segmented", ...a }, n) => /* @__PURE__ */ r.jsx(b.Provider, { value: t, children: /* @__PURE__ */ r.jsx(F, { ref: n, ...a }) }));
...
//# sourceMappingURL=tabs-CUUYpcMr.mjs.map
