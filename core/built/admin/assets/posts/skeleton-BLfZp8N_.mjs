import { al as K, x as C, Q as f, aj as O, a8 as te, a5 as B, a6 as vo, k as yo, p as bo, ae as Me, ac as Mo, F as Co, i as q, S as $t, a0 as Gt } from "./index-cYbhPZer.mjs";
import { q as je, g as Pe, m as ne, i as nt, p as ot, b as Z, d as D, n as Bt, u as We, a as ze, P as Ao, l as So, k as Ro, o as Po, R as _o, F as Eo, D as Do, e as Kt, h as Wt, C as Oo } from "./check-Bk1CoFjE.mjs";
function Io(e) {
  const [t, n] = K(void 0);
  return je(() => {
    if (e) {
...
function _t(e, t, n) {
  ...
  const s = J(t), i = dt(t), c = ut(i), d = se(t), u = s === "y", l = o.x + o.width / 2 - r.width / 2, a = o.y + o.height / 2 - r.height / 2, p = o[c] / 2 - r[c] / 2;
  let m;
  switch (d) {
    case "top":
      m = {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const w = se(r), M = J(c), y = se(c) === c, v = await (d.isRTL == null ? void 0 : d.isRTL(u.floating)), S = p || (y || !x ? [ke(c)] : Fo(c)), A = h !== "none";
      ...
      if (I = [...I, {
        ...
        if (G && (!(a === "alignment" ? M !== J(G) : !1) || // We leave the current main axis only if every placement on that axis
        // overflows the main axis.
        I.every((R) => J(R.placement) === M ? R.overflows[0] > 0 : !0)))
          return {
            data: {
              index: N,
              overflows: I
...
async function Yo(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), i = se(n), c = we(n), d = J(n) === "y", u = Ht.has(i) ? -1 : 1, l = s && d ? -1 : 1, a = re(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: h
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: o
      }, a = await s.detectOverflow(t, u), p = J(se(r)), m = lt(p);
      let h = l[m], x = l[p];
      if (i) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...u
      } = re(e, t), l = await i.detectOverflow(t, u), a = se(r), p = we(r), m = J(r) === "y", {
        width: h,
        height: x
      } = s.floating;
      let g, w;
...
function Qt(e, t) {
  ...
  for (; o && Jo(o) && Je(o); )
    o = Tt(o, t);
  return o && xe(o) && Je(o) && !ft(o) ? n : o || nr(e) || n;
}
...
function xr(e, t) {
  ...
  function i(c, d) {
    ...
    function S(A) {
      ...
      P === 1 && !Jt(u, e.getBoundingClientRect()) && i(), v = !1;
    }
    try {
...
function wr(e, t, n, o) {
  ...
  function g() {
    const w = pe(e);
    x && !Jt(x, w) && n(), x = w, h = requestAnimationFrame(g);
  }
  return n(), () => {
    var w;
    l.forEach((M) => {
...
const vr = Xo, yr = qo, br = Vo, Mr = Qo, Cr = Uo, jt = Ho, Ar = Zo, Sr = (e, t, n) => {
...
un.displayName = qr;
var Zr = un, ht = "Popper", [dn, fn] = Pe(ht), [Qr, pn] = dn(ht), mn = (e) => {
...
gn.displayName = hn;
var gt = "PopperContent", [Jr, es] = dn(gt), xn = C(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
...
var U = "MenuContent", [ws, yt] = me(U), Rn = C(
  ...
  (e, t) => {
    const {
      ...
      const $ = I.current + b, Q = v().filter((W) => !W.disabled), ce = document.activeElement, ye = Q.find((W) => W.ref.current === ce)?.textValue, be = Q.map((W) => W.textValue), Ie = Ns(be, $, ye), de = Q.find((W) => W.textValue === Ie)?.ref.current;
      (function W(ae) {
                    ...
                    children: /* @__PURE__ */ f.jsx(
                      is,
                      {
                        ...
                        onKeyDown: D(x.onKeyDown, (b) => {
                          const Q = b.target.closest("[data-radix-menu-content]") === b.currentTarget, ce = b.ctrlKey || b.altKey || b.metaKey, ye = b.key.length === 1;
                          Q && (b.key === "Tab" && b.preventDefault(), !ce && ye && k(b.key));
                          const be = P.current;
                        ...
                        onPointerMove: D(
                          e.onPointerMove,
                          Re((b) => {
                            const $ = b.target, Q = N.current !== b.clientX;
                            if (b.currentTarget.contains($) && Q) {
...
Qn.displayName = ni;
var oi = "DropdownMenuCheckboxItem", Jn = C((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = z(n);
...
ro.displayName = fi;
var pi = zn, mi = Vn, hi = Un, so = Xn, gi = qn, io = Zn, co = Qn, ao = Jn, lo = eo, uo = to, fo = no, po = oo, mo = ro;
...
//# sourceMappingURL=skeleton-BLfZp8N_.mjs.map
