import { Q as e, i as Y, ag as J, af as A, ae as j, v as C, u as f, a3 as ie, a8 as le } from "./index-cYbhPZer.mjs";
import { u as ne, c as oe, D as ce } from "./growth-DH1-qR8g.mjs";
import { K as L, b as _, a as T, d as S } from "./stats-9paN74VC.mjs";
import { B as O } from "./button-DJdXBRcJ.mjs";
import { C as V, d as E, e as K, a as y, u as F, i as de, j as me, g as pe, f as xe } from "./post-analytics-header-eq6HOCwL.mjs";
import { D as ue, i as he, p as ge, h as je, l as fe, m as ve, n as be, o as Ne } from "./data-list-VwfcMcy-.mjs";
import { B as P } from "./loading-indicator-CnQS5ZPO.mjs";
import { S as R } from "./get-site-timezone-C7k0KEIU.mjs";
import { b as X } from "./heading-H8w4s0rm.mjs";
import { c as ye, i as we, a as q, G as ke, f as Ce, K as Le, g as _e } from "./kpis-B0f0jApg.mjs";
import { a as Te, p as Se, N as Re, c as De } from "./links-Bg8tpJnH.mjs";
import { M as Ie } from "./mail-BzgBa-LU.mjs";
import { L as ze } from "./post-share-modal-A8tzSPp2.mjs";
import { E as Ae } from "./empty-indicator-C4EOv-cX.mjs";
import { u as Z, c as Oe } from "./post-analytics-context-B4IsnOq1.mjs";
import { u as Q } from "./skeleton-BLfZp8N_.mjs";
import { h as Ve, e as Ee, d as U, s as Ke } from "./app-utils-CJzAPXLk.mjs";
const D = ({ children: r, className: t, ...n }) => /* @__PURE__ */ e.jsx(
    ...
    t ? /* @__PURE__ */ e.jsx(y, { children: /* @__PURE__ */ e.jsx("div", { className: "mx-auto flex min-h-[250px] items-center justify-center xl:size-full", children: /* @__PURE__ */ e.jsx(P, {}) }) }) : /* @__PURE__ */ e.jsxs(y, { className: `${o && "grid grid-cols-2"}`, children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: `${o && "pl-6"}`, children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: o ? "" : "pt-3", children: [
          ...
          u.length > 0 ? /* @__PURE__ */ e.jsx(ue, { className: "", children: /* @__PURE__ */ e.jsx(he, { children: u.slice(0, o ? 10 : 5).map((c) => {
  ...
  const { postId: p } = J(), u = A(), { data: h } = Z(), d = h?.url, o = h?.icon, c = j(() => a ? a.reduce((l, x) => l + Number(x.visits || 0), 0) : 0, [a]);
  ...
  const r = A(), { statsConfig: t, isLoading: n, post: s, isPostLoading: a, postId: i } = Z(), { totals: p, isLoading: u, currencySymbol: h } = ne(i), { appSettings: d } = ie(), { emailTrackClicks: o, emailTrackOpens: c } = d?.analytics || {}, l = j(() => s?.published_at ? Ve(s.published_at) : Oe.ALL_TIME.value, [s?.published_at]), { startDate: x, endDate: $, timezone: M } = Ee(l), W = j(() => {
    const m = {
      site_uuid: t?.id || "",
      date_from: U(x),
      date_to: U($),
    ...
    statsConfig: t || { id: "" },
    params: W
  }), G = n || u || a || B, re = a || n || B, w = de(s) && c && o, k = !s?.email_only && d?.analytics.webAnalytics, N = d?.analytics.membersTrackSources;
  return le(() => {
...
//# sourceMappingURL=overview-C9Efe9DB.mjs.map
