import { x as v, Q as s, aj as g, al as E, a5 as x, a8 as A, S as G, i as K } from "./index-cYbhPZer.mjs";
import { m as j, b, d as m, n as B, p as Q, a as N, P as U, g as V, l as W, R as Z, i as q, o as J, F as X, D as Y } from "./check-Bk1CoFjE.mjs";
import { A as y, s as ee, B as S, f as oe, b as te } from "./skeleton-BLfZp8N_.mjs";
var O = "Popover", [F] = V(O, [
  S
]), C = S(), [re, f] = F(O), w = (e) => {
  const {
...
var _ = "PopoverPortal", [ae, se] = F(_, {
  ...
  return /* @__PURE__ */ s.jsx(ae, { scope: n, forceMount: r, children: /* @__PURE__ */ s.jsx(N, { present: r || t.open, children: /* @__PURE__ */ s.jsx(U, { asChild: !0, container: o, children: a }) }) });
};
I.displayName = _;
...
T.displayName = h;
var ce = q("PopoverContent.RemoveScroll"), ie = v(
  (e, n) => {
    const r = f(h, e.__scopePopover), a = g(null), o = j(n, a), t = g(!1);
    return A(() => {
      const c = a.current;
      if (c) return W(c);
    }, []), /* @__PURE__ */ s.jsx(Z, { as: ce, allowPinchZoom: !0, children: /* @__PURE__ */ s.jsx(
      L,
      {
        ...e,
        ref: o,
...
//# sourceMappingURL=popover-C0ysVMxw.mjs.map
