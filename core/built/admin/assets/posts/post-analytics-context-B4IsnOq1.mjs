import { ag as v, al as k, Q as P, a6 as h, k as E } from "./index-cYbhPZer.mjs";
import { u as I, a as D } from "./settings-CTfrowFd.mjs";
import { u as C } from "./posts-BOgcdu2l.mjs";
import { d as N } from "./hooks-DxTWmWfO.mjs";
import { u as w } from "./site-EKvZjM5G.mjs";
...
const Y = (o = {}) => {
  ...
  const t = I(), e = w(), [n, T] = k(x.LAST_30_DAYS.value), d = D(), i = !!t.data?.config?.stats, r = Y({ enabled: i }), { data: { posts: [y] } = { posts: [] }, isLoading: b } = C({
    searchParams: {
      filter: `id:${s}`,
  ...
  return /* @__PURE__ */ P.jsx(m.Provider, { value: {
    data: t.data?.config,
    site: _,
...
//# sourceMappingURL=post-analytics-context-B4IsnOq1.mjs.map
