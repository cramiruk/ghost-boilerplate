import { a5 as A, k as $, ae as M, Q as D, a6 as Y, ac as _e, aj as P, a8 as w, al as R, o as ge, C as re, g as H, ai as Je, x as L, M as oe, F as be, p as et, m as tt, l as O } from "./index-cYbhPZer.mjs";
var T = function() {
...
function Bn(e, t) {
  ...
  const r = (a) => {
    const { children: c, ...i } = a, f = M(() => i, Object.values(i));
    return /* @__PURE__ */ D.jsx(n.Provider, { value: f, children: c });
  };
...
function Un(e, t = []) {
  ...
  function r(a, c) {
    ...
    n = [...n, c];
    const u = (d) => {
      const { scope: v, children: h, ...y } = d, s = v?.[e]?.[f] || i, m = M(() => y, Object.values(y));
      return /* @__PURE__ */ D.jsx(s.Provider, { value: m, children: h });
    };
...
var bt = (e) => `${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`, Et = (e) => `${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`, Z = ge[" use ".trim().toString()], St = [
  ...
  const n = /* @__PURE__ */ Be(`Primitive.${t}`), r = L((o, a) => {
    ...
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = !0), /* @__PURE__ */ D.jsx(f, { ...i, ref: a });
  });
...
var Nt = "DismissableLayer", pe = "dismissableLayer.update", At = "dismissableLayer.pointerDownOutside", Rt = "dismissableLayer.focusOutside", Pe, je = $({
  ...
  (e, t) => {
    ...
    return Ot((g) => {
      ...
      if (l)
        return n && (u.layersWithOutsidePointerEventsDisabled.size === 0 && (Pe = v.body.style.pointerEvents, v.body.style.pointerEvents = "none"), u.layersWithOutsidePointerEventsDisabled.add(l)), u.layers.add(l), Oe(), () => {
      ...
      l && (u.layers.delete(l), u.layersWithOutsidePointerEventsDisabled.delete(l), Oe());
    }, [l, u]), w(() => {
      const g = () => h({});
...
var Lt = "DismissableLayerBranch", xt = L((e, t) => {
  ...
  }, [n.branches]), /* @__PURE__ */ D.jsx(ie.div, { ...e, ref: o });
});
xt.displayName = Lt;
...
var Dt = "Portal", kt = L((e, t) => {
  const { container: n, ...r } = e, [o, a] = R(!1);
  K(() => a(!0), []);
  const c = n || o && globalThis?.document?.body;
  return c ? tt(/* @__PURE__ */ D.jsx(ie.div, { ...r, ref: t }), c) : null;
});
kt.displayName = Dt;
var G = 0, F = null;
function Vn() {
...
var ue = "focusScope.autoFocusOnMount", le = "focusScope.autoFocusOnUnmount", Ae = { bubbles: !1, cancelable: !0 }, Ft = "FocusScope", _t = L((e, t) => {
  ...
  return /* @__PURE__ */ D.jsx(ie.div, { tabIndex: -1, ...c, ref: v, onKeyDown: y });
});
_t.displayName = Ft;
...
`);
  ...
  return O(fn, { styles: vn(a, !t, o, n ? "" : "!important") });
}, ye = !1;
if (typeof window < "u")
  try {
...
function Nn(e) {
  var t = P([]), n = P([0, 0]), r = P(), o = R(On++)[0], a = R(ze)[0], c = P(e);
  w(function() {
    c.current = e;
  }, [e]), w(function() {
    if (e.inert) {
  ...
  var i = A(function(s, m) {
    ...
    var p = ee(s), b = n.current, E = "deltaX" in s ? s.deltaX : b[0] - p[0], S = "deltaY" in s ? s.deltaY : b[1] - p[1], C, N = s.target, g = Math.abs(E) > Math.abs(S) ? "h" : "v";
    if ("touches" in s && g === "h" && N.type === "range")
      return !1;
    var I = window.getSelection(), k = I && I.anchorNode, j = k ? k === N || k.contains(N) : !1;
    if (j)
      return !1;
    var z = Me(g, N);
    if (!z)
      return !0;
    if (z ? C = g : (C = g === "v" ? "h" : "v", z = Me(g, N)), !z)
      return !1;
    ...
    if (!(!B.length || B[B.length - 1] !== a)) {
      var p = "deltaY" in m ? De(m) : ee(m), b = t.current.filter(function(C) {
    ...
    u(s.type, De(s), s.target, i(s, e.lockRef.current));
  }, []), v = A(function(s) {
  ...
  return O(
    be,
    null,
    y ? O(a, { styles: Pn(o) }) : null,
    h ? O(mn, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function An(e) {
...
var Tn = L(function(e, t) {
  return O(ce, T({}, e, { ref: t, sideCar: Rn }));
});
...
function zn({
  ...
  return O(qe.Provider, { value: c }, e);
}
const Mn = () => Y(qe), Dn = L(
  ({ color: e, size: t, strokeWidth: n, absoluteStrokeWidth: r, className: o = "", children: a, iconNode: c, ...i }, f) => {
    const {
      ...
      className: h = ""
    } = Mn() ?? {}, y = r ?? d ? Number(n ?? l) * 24 / Number(t ?? u) : n ?? l;
    return O(
      "svg",
      {
        ref: f,
...
//# sourceMappingURL=check-Bk1CoFjE.mjs.map
