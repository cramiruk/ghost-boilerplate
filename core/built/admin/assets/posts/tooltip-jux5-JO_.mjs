import { b as G, p as te, n as oe, m as V, d as P, a as F, P as re, g as ne, D as se, j as ae, h as $ } from "./check-Bk1CoFjE.mjs";
import { x as w, Q as l, aj as g, a8 as b, a5 as m, al as z, ae as ie, S as ce, i as le } from "./index-cYbhPZer.mjs";
import { s as ue, A as de, B, f as pe, b as fe } from "./skeleton-BLfZp8N_.mjs";
...
var R = "Tooltip", [Te, D] = L(R), W = (e) => {
  const {
    ...
    delayDuration: v
  } = e, s = S(R, e.__scopeTooltip), u = O(o), [c, d] = z(null), f = te(), p = g(0), h = a ?? s.disableHoverableContent, y = v ?? s.delayDuration, x = g(!1), [C, T] = oe({
    prop: r,
    defaultProp: n ?? !1,
    onChange: (k) => {
      k ? (s.onOpen(), document.dispatchEvent(new CustomEvent(N))) : s.onClose(), i?.(k);
    },
    caller: R
  ...
  return b(() => () => {
    ...
    Te,
    {
      ...
      onTriggerChange: d,
      onTriggerEnter: m(() => {
        s.isOpenDelayedRef.current ? H() : A();
      }, [s.isOpenDelayedRef, H, A]),
      onTriggerLeave: m(() => {
        h ? j() : (window.clearTimeout(p.current), p.current = 0);
      }, [j, h]),
      onOpen: A,
      onClose: j,
...
K.displayName = I;
var E = "TooltipContent", Q = w(
  (e, o) => {
    const t = Ce(E, e.__scopeTooltip), { forceMount: r = t.forceMount, side: n = "top", ...i } = e, a = D(E, e.__scopeTooltip);
    return /* @__PURE__ */ l.jsx(F, { present: r || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ l.jsx(J, { side: n, ...i, ref: o }) : /* @__PURE__ */ l.jsx(be, { side: n, ...i, ref: o }) });
  }
), be = w((e, o) => {
  const t = D(E, e.__scopeTooltip), r = S(E, e.__scopeTooltip), n = g(null), i = V(o, n), [a, v] = z(null), { trigger: s, onClose: u } = t, c = n.current, { onPointerInTransitChange: d } = r, f = m(() => {
    ...
    (h, y) => {
      const x = h.currentTarget, C = { x: h.clientX, y: h.clientY }, T = Ae(C, x.getBoundingClientRect()), _ = je(C, T), A = Re(y.getBoundingClientRect()), j = Le([..._, ...A]);
      v(j), d(!0);
    },
    [d]
  );
  ...
  }, [s, c, a, u, f]), /* @__PURE__ */ l.jsx(J, { ...e, ref: i });
}), [we, Pe] = L(R, { isInside: !1 }), Ee = ae("TooltipContent"), J = w(
  (e, o) => {
    const {
      __scopeTooltip: t,
      children: r,
...
], Be = $("eye", ke), Ye = Ne, Ue = Me, qe = Se, Ge = w(({ className: e, sideOffset: o = 4, ...t }, r) => /* @__PURE__ */ l.jsx(Ie, { children: /* @__PURE__ */ l.jsx("div", { className: ce, children: /* @__PURE__ */ l.jsx(
  ee,
  {
    ref: r,
    className: le(
...
//# sourceMappingURL=tooltip-jux5-JO_.mjs.map
