...
async function trigger(trx, { memberEmail, memberId, memberStatus }) {
...
async function finishStepAndEnqueueNext(trx, step) {
...
async function replaceAutomationGraph(trx, automationId, actions, edges) {
